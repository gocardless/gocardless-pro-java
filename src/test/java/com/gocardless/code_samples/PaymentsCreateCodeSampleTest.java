...
public class PaymentsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            Payment payment = client.payments().create().withAmount(100).withCurrency(Currency.GBP)
                    .withChargeDate("2014-05-19").withReference("WINEBOX001")
                    .withMetadata("order_dispatch_date", "2014-05-22").withLinksMandate("MD123")
                    .execute();
        } finally {
