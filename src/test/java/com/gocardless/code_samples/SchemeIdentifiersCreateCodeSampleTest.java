...
public class SchemeIdentifiersCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        String responseBody = "{ \"scheme_identifiers\": {} }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            SchemeIdentifier schemeIdentifier =
                    client.schemeIdentifiers().create().withScheme(Scheme.BACS)
                            .withName("The Wine Club").withLinksCreditor("CR123").execute();
        } finally {
