...
public class BillingRequestsNotifyCodeSampleTest {
    ...
    @Test
    public void testNotifyCodeSample() throws Exception {
        ...
        try {
            client.billingRequests().notify("BR123").withNotificationType("email")
                    .withRedirectUri("https://my-company.com").execute();
        } finally {
