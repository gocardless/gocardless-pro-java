...
public class CreditorsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            Creditor creditor = client.creditors().create().withName("Acme").withCountryCode("GB")
                    .withCreditorType(CreditorType.COMPANY).withBankReferencePrefix("ACME")
                    .execute();
        } finally {
