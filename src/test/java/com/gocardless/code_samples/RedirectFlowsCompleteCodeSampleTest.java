...
public class RedirectFlowsCompleteCodeSampleTest {
    ...
    @Test
    public void testCompleteCodeSample() throws Exception {
        ...
        try {
            client.redirectFlows().complete("RE123").withSessionToken("SESS_wSs0uGYMISxzqOBq")
                    .execute();
        } finally {
