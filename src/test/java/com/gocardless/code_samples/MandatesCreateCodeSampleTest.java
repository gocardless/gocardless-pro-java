...
public class MandatesCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            Mandate mandate = client.mandates().create().withScheme("bacs")
                    .withLinksCustomerBankAccount("BA123").withMetadata("contract", "ABCD1234")
                    .execute();
        } finally {
