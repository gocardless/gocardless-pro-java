...
public class BankDetailsLookupsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        String responseBody = "{ \"bank_details_lookups\": {} }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            BankDetailsLookup bankDetailsLookup =
                    client.bankDetailsLookups().create().withAccountNumber("55779911")
