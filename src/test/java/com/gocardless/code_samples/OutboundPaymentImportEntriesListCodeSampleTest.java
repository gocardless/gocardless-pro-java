...
public class OutboundPaymentImportEntriesListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"outbound_payment_import_entries\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            client.outboundPaymentImportEntries().list().withOutboundPaymentImport("IM123")
                    .withLimit(10).execute();
        } finally {
