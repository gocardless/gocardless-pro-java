...
public class RefundsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            client.refunds().create().withAmount(100).withTotalAmountConfirmation(150)
                    .withReference("Acme refund").withMetadata("reason", "late delivery")
                    .withLinksPayment("PM123").execute();
        } finally {
