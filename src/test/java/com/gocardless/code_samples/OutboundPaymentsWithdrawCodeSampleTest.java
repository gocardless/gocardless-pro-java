...
public class OutboundPaymentsWithdrawCodeSampleTest {
    ...
    @Test
    public void testWithdrawCodeSample() throws Exception {
        ...
        try {
            OutboundPayment outboundPayment = client.outboundPayments().withdraw().withAmount(5000)
