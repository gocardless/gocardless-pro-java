...
public class PayerAuthorisationsConfirmCodeSampleTest {
    ...
    @Test
    public void testConfirmCodeSample() throws Exception {
        ...
        try {
            PayerAuthorisation payerAuthorisation =
                    client.payerAuthorisations().confirm("PAU123").execute();
        } finally {
