...
public class PaymentAccountTransactionsListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"payment_account_transactions\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            client.paymentAccountTransactions().list("BA12345").withValueDateFrom("2024-01-01")
                    .withValueDateTo("2024-01-31").execute();
        } finally {
