...
public class BillingRequestTemplatesListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"billing_request_templates\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (BillingRequestTemplate billingRequestTemplate : client.billingRequestTemplates()
                    .all().execute()) {
