...
public class InstitutionsListForBillingRequestCodeSampleTest {
    ...
    @Test
    public void testListForBillingRequestCodeSample() throws Exception {
        // Mock response - enqueue multiple times to handle code samples with multiple API calls
        String responseBody =
                "{ \"institutions\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
