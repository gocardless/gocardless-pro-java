...
public class CreditorBankAccountsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        String responseBody = "{ \"creditor_bank_accounts\": {} }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            CreditorBankAccount creditorBankAccount = client.creditorBankAccounts().create()
                    .withAccountNumber("55779911").withBranchCode("200000").withCountryCode("GB")
                    .withAccountHolderName("Acme").withLinksCreditor("CR123").execute();
        } finally {
