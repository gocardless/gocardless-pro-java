...
public class CreditorBankAccountsListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"creditor_bank_accounts\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (CreditorBankAccount creditorBankAccount : client.creditorBankAccounts().all()
                    .withCreditor("CR123").execute()) {
