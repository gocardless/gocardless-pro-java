...
public class CustomersCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            Customer customer = client.customers().create().withEmail("user@example.com")
                    .withGivenName("Frank").withFamilyName("Osborne")
                    .withAddressLine1("27 Acer Road").withAddressLine2("Apt 2").withCity("London")
                    .withPostalCode("E8 3GX").withCountryCode("GB")
                    .withMetadata("salesforce_id", "ABCD1234").execute();
        } finally {
