...
public class BillingRequestTemplatesCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        String responseBody = "{ \"billing_request_templates\": {} }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            BillingRequestTemplate billingRequestTemplate = client.billingRequestTemplates()
                    .create().withPaymentRequestDescription("One-time joining fee")
                    .withPaymentRequestCurrency("GBP").withPaymentRequestAmount("69.99")
                    .withMandateRequestCurrency("GBP")
                    .withRedirectUri("https://my-company.com/landing").execute();
        } finally {
