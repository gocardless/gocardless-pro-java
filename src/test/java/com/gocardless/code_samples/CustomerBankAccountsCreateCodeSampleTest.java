...
public class CustomerBankAccountsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        String responseBody = "{ \"customer_bank_accounts\": {} }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            CustomerBankAccount customerBankAccount =
                    client.customerBankAccounts().create().withAccountNumber("55779911")
                            .withBranchCode("200000").withAccountHolderName("Frank Osborne")
                            .withCountryCode("GB").withLinksCustomer("CU123").execute();
        } finally {
