...
public class CustomerBankAccountsListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"customer_bank_accounts\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (CustomerBankAccount customerBankAccount : client.customerBankAccounts().all()
                    .withCustomer("CU123").withEnabled(true).execute()) {
