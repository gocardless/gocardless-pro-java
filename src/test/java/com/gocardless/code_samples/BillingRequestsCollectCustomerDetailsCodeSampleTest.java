...
public class BillingRequestsCollectCustomerDetailsCodeSampleTest {
    ...
    @Test
    public void testCollectCustomerDetailsCodeSample() throws Exception {
        ...
        try {
            client.billingRequests().collectCustomerDetails("BR123")
                    .withCustomerEmail("alice@example.com").withCustomerGivenName("Alice")
                    .withCustomerFamilyName("Smith")
                    .withCustomerBillingDetailAddressLine1("1 Somewhere Lane").execute();
        } finally {
