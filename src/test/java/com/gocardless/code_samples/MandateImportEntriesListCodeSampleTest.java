...
public class MandateImportEntriesListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"mandate_import_entries\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (MandateImportEntry entry : client.mandateImportEntries().all()
                    .withMandateImport("IM000010790WX1").execute()) {
