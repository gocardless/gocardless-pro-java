...
import com.gocardless.services.InstalmentScheduleService.InstalmentScheduleCreateWithDatesRequest.Currency;
import com.gocardless.services.InstalmentScheduleService.InstalmentScheduleCreateWithDatesRequest.Instalments;
...
public class InstalmentSchedulesCreateWithDatesCodeSampleTest {
    ...
    @Test
    public void testCreateWithDatesCodeSample() throws Exception {
        ...
        try {
            InstalmentSchedule instalmentSchedule = client.instalmentSchedules().createWithDates()
                    ...
                    .withInstalments(Arrays.asList(
                            new Instalments().withAmount(3400).withChargeDate("2019-08-20"),
                            new Instalments().withAmount(3400).withChargeDate("2019-09-03"),
                            new Instalments().withAmount(3200).withChargeDate("2019-09-17")))
