...
public class MandatePdfsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            MandatePdf mandatePdfForMandate =
                    client.mandatePdfs().create().withLinksMandate("MD123").execute();
            MandatePdf mandatePdfForBankDetails =
                    client.mandatePdfs().create().withAccountNumber("44779911")
                            .withBranchCode("200000").withCountryCode("GB").execute();
            MandatePdf mandatePdfInFrench =
                    client.mandatePdfs().create().withIban("FR14BARC20000055779911")
                            .withHeader("Accept-Language", "fr").execute();
        } finally {
