...
public class OutboundPaymentImportsListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"outbound_payment_imports\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            client.outboundPaymentImports().list().withLimit(10).execute();
        } finally {
