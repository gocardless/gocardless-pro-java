...
public class BillingRequestsCollectBankAccountCodeSampleTest {
    ...
    @Test
    public void testCollectBankAccountCodeSample() throws Exception {
        ...
        try {
            client.billingRequests().collectBankAccount("BR123").withAccountNumber("55779911")
