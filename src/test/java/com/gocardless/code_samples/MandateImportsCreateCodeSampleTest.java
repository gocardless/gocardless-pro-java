...
public class MandateImportsCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        String responseBody = "{ \"mandate_imports\": {} }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            MandateImport mandateImport = client.mandateImports().create().withScheme(
                    com.gocardless.services.MandateImportService.MandateImportCreateRequest.Scheme.BACS)
                    .execute();
        } finally {
