...
public class BlocksCreateCodeSampleTest {
    ...
    public void testCreateCodeSample() throws Exception {
        ...
        try {
            Block block = client.blocks().create().withBlockType("email")
                    .withReasonType("no_intent_to_pay").withResourceReference("example@example.com")
                    .execute();
        } finally {
