...
public class WebhooksListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"webhooks\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (com.gocardless.resources.Webhook webhook : client.webhooks().all()
                    .withSuccessful(true).execute()) {
