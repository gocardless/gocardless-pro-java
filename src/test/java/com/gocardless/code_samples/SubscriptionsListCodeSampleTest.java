...
public class SubscriptionsListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"subscriptions\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (Subscription subscription : client.subscriptions().all().withCustomer("CU123")
                    .execute()) {
