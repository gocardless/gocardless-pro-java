...
public class InstalmentSchedulesListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"instalment_schedules\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            for (InstalmentSchedule instalmentSchedule : client.instalmentSchedules().all()
                    .execute()) {
