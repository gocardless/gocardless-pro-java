...
public class NegativeBalanceLimitsListCodeSampleTest {
    ...
    public void testListCodeSample() throws Exception {
        ...
        String responseBody =
                "{ \"negative_balance_limits\": [{}], \"meta\": { \"cursors\": {}, \"limit\": 50 } }";
        for (int i = 0; i < 5; i++) {
        ...
        try {
            client.negativeBalanceLimits().all().withCreditor("CR123").withCurrency(Currency.GBP)
                    .execute();
        } finally {
