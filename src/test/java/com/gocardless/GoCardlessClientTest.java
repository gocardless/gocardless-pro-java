...
public class GoCardlessClientTest {
        ...
        public void shouldGetACustomer() throws Exception {
                http.enqueueResponse(200, "fixtures/client/get_single_event.json");
                Event event = client.events().get("EV123").execute();
                assertThat(event.getId()).isEqualTo("EV123");
                // assertThat(event.get.isEqualTo("Osborne");
                // assertThat(event.getGivenName()).isEqualTo("Frank");
                http.assertRequestMade("GET", "/events/EV123",
        ...
        public void shouldGetACustomerWrapped() throws Exception {
                ...
                http.assertRequestMade("GET", "/customers/CU00003068FG73",
                                ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
        }

        public void shouldListCustomers() throws Exception {
                http.enqueueResponse(200, "fixtures/client/list_customers.json");
                List<Customer> customers = client.customers().list().withHeader("Accept-Language", "fr-FR").execute()
                                .getItems();
        ...
        public void shouldListMandatesForACustomer() throws Exception {
                ...
                List<Mandate> mandates = client.mandates().list().withCustomer("CU00003068FG73").execute().getItems();
        ...
        public void shouldListMandatesByCustomerAndStatus() throws Exception {
                ...
                List<Mandate> mandates = client.mandates().list().withCustomer("CU00003068FG73").withStatus(ACTIVE)
        ...
        public void shouldCreateACustomer() throws Exception {
                ...
                http.assertRequestMade("POST", "/customers", "fixtures/client/create_a_customer_request.json",
                                ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
        }
        ...
        public void shouldCreateACustomerWithAGeneratedIdempotencyKey() throws Exception {
                http.enqueueResponse(201, "fixtures/client/create_a_customer_response.json");
                CustomerCreateRequest request = client.customers().create().withHeader("Accept-Language", "fr-FR")
                                .withFamilyName("Osborne").withGivenName("Sharon").withAddressLine1("27 Acer Road")
                                .withAddressLine2("Apt 2").withCity("London").withPostalCode("E8 3GX")
                                .withCountryCode("GB");
                request.execute();
        ...
        public void shouldHandleConflictWhenCreatingACustomer() throws Exception {
                ...
                http.assertRequestMade("POST", "/customers", "fixtures/client/create_a_customer_request.json",
                                ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
                http.assertRequestMade("GET", "/customers/ID123",
                                ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
        }
        ...
        public void shouldUpdateACustomer() throws Exception {
                ...
                Customer customer = client.customers().update("CU000031FFQ5H3").withHeader("Accept-Language", "fr-FR")
        ...
        public void shouldGetCustomersCreatedAfter() throws Exception {
                ...
                List<Customer> result = client.customers().list().withCreatedAtGte("2015-04-13T15:02:40Z").execute()
                                .getItems();
        ...
        public void shouldPageThroughMandates() throws Exception {
                ...
                ListResponse<Mandate> page1 = client.mandates().list().withHeader("Accept-Language", "fr-FR")
                                .withLimit(2).execute();
                ...
                ListResponse<Mandate> page2 = client.mandates().list().withHeader("Accept-Language", "fr-FR")
                                .withLimit(2).withAfter(page1.getAfter()).execute();
        ...
        public void shouldIterateThroughMandates() throws Exception {
                http.enqueueResponse(200, "fixtures/client/list_mandates_page_1.json");
                http.enqueueResponse(200, "fixtures/client/list_mandates_page_2.json");
                Iterable<Mandate> iterable = client.mandates().all().withHeader("Accept-Language", "fr-FR").withLimit(2)
                                .execute();
        ...
        public void shouldCancelAMandate() throws Exception {
                ...
                Mandate mandate = client.mandates().cancel("MD00001P1KTRNY").withHeader("Accept-Language", "fr-FR")
        ...
        public void shouldCreateASubscription() throws Exception {
                ...
                Subscription subscription = client.subscriptions().create().withAmount(1000).withCurrency("GBP")
                                .withIntervalUnit(MONTHLY).withLinksMandate("MD00001PEYCSQF").execute();
                assertThat(subscription.getId()).isNotNull();
                http.assertRequestMade("POST", "/subscriptions", "fixtures/client/create_a_subscription_request.json",
                                ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
        }
        ...
        public void shouldListEnabledCreditorBankAccounts() throws Exception {
                ...
                Iterable<CreditorBankAccount> iterable = client.creditorBankAccounts().all().withEnabled(true)
                                .execute();
