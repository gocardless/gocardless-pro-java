...
public class GoCardlessClientTest {
    ...
    public void shouldGetACustomer() throws Exception {
        ...
        http.assertRequestMade("GET", "/customers/CU00003068FG73", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }

    @Test
    public void shouldGetACustomerWrapped() throws Exception {
        http.enqueueResponse(200, "fixtures/client/get_a_customer.json", ImmutableMap.of("RateLimit-Limit", "1000"));

        ApiResponse<Customer> response = client.customers()
            .get("CU00003068FG73")
        ...
        http.assertRequestMade("GET", "/customers/CU00003068FG73", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldListCustomers() throws Exception {
        ...
        http.assertRequestMade("GET", "/customers", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldListMandatesForACustomer() throws Exception {
        ...
        assertThat(mandates.get(1).getStatus()).isEqualTo(Mandate.Status.ACTIVE);

        http.assertRequestMade("GET", "/mandates?customer=CU00003068FG73", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldListMandatesByCustomerAndStatus() throws Exception {
        ...
        http.assertRequestMade("GET", "/mandates?customer=CU00003068FG73&status=active%2Cfailed", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldCreateACustomer() throws Exception {
        ...
        http.assertRequestMade("POST", "/customers", "fixtures/client/create_a_customer_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldHandleConflictWhenCreatingACustomer() throws Exception {
        ...
        http.assertRequestMade("POST", "/customers", "fixtures/client/create_a_customer_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
        http.assertRequestMade("GET", "/customers/ID123",  ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldUpdateACustomer() throws Exception {
        ...
        http.assertRequestMade("PUT", "/customers/CU000031FFQ5H3", "fixtures/client/update_a_customer_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldGetCustomersCreatedAfter() throws Exception {
        ...
        List<Customer> result = client.customers().list()
                .withCreatedAtGte("2015-04-13T15:02:40Z")
                .execute()
                .getItems();
        ...
        http.assertRequestMade("GET", "/customers?created_at%5Bgte%5D=2015-04-13T15%3A02%3A40Z", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldCreateAPayment() throws Exception {
        ...
        Payment payment = client.payments().create()
                .withAmount(2000)
                .withCurrency(PaymentCreateRequest.Currency.GBP)
        ...
        http.assertRequestMade("POST", "/payments", "fixtures/client/create_a_payment_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldPageThroughMandates() throws Exception {
        ...
        assertThat(page1.getItems().get(0).getStatus()).isEqualTo(Mandate.Status.ACTIVE);

        assertThat(page1.getItems().get(1).getId()).isEqualTo("MD00001P57AN84");
        assertThat(page1.getItems().get(1).getStatus()).isEqualTo(Mandate.Status.CANCELLED);

        assertThat(page1.getBefore()).isNull();
        assertThat(page1.getAfter()).isNotNull();
        assertThat(page1.getLimit()).isEqualTo(2);

        http.assertRequestMade("GET", "/mandates?limit=2", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));

        http.enqueueResponse(200, "fixtures/client/list_mandates_page_2.json");

        ListResponse<Mandate> page2 = client.mandates().list()
                .withHeader("Accept-Language", "fr-FR")
                .withLimit(2)
                .withAfter(page1.getAfter())
                .execute();

        assertThat(page2.getItems()).hasSize(1);
        assertThat(page2.getItems().get(0).getId()).isEqualTo("MD00001P1KTRNY");
        assertThat(page2.getItems().get(0).getStatus()).isEqualTo(Mandate.Status.ACTIVE);

        assertThat(page2.getBefore()).isNotNull();
        assertThat(page2.getAfter()).isNull();
        assertThat(page2.getLimit()).isEqualTo(2);

        http.assertRequestMade("GET", "/mandates?after=MD00001P57AN84&limit=2", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldIterateThroughMandates() throws Exception {
        ...
        Iterable<Mandate> iterable = client.mandates().all()
            .withHeader("Accept-Language", "fr-FR")
            .withLimit(2)
            .execute();
        ...
        assertThat(mandates.get(0).getStatus()).isEqualTo(Mandate.Status.ACTIVE);
        assertThat(mandates.get(1).getId()).isEqualTo("MD00001P57AN84");
        assertThat(mandates.get(1).getStatus()).isEqualTo(Mandate.Status.CANCELLED);
        assertThat(mandates.get(2).getId()).isEqualTo("MD00001P1KTRNY");
        assertThat(mandates.get(2).getStatus()).isEqualTo(Mandate.Status.ACTIVE);
    ...
    public void shouldCancelAMandate() throws Exception {
        ...
        assertThat(mandate.getStatus()).isEqualTo(Mandate.Status.CANCELLED);

        http.assertRequestMade("POST", "/mandates/MD00001P1KTRNY/actions/cancel", "fixtures/client/cancel_a_mandate_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldCreateASubscription() throws Exception {
        ...
        http.assertRequestMade("POST", "/subscriptions", "fixtures/client/create_a_subscription_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldCreateASubscriptionWithSpecifiedIdempotencyKey() throws Exception {
        ...
        http.assertRequestMade("POST", "/subscriptions", "fixtures/client/create_a_subscription_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN, "Idempotency-Key", "lol", "Accept-Language", "fr-FR"));
    }
    ...
    public void shouldListEnabledCreditorBankAccounts() throws Exception {
        ...
        Iterable<CreditorBankAccount> iterable = client.creditorBankAccounts().all().withEnabled(true).execute();
        ...
        http.assertRequestMade("GET", "/creditor_bank_accounts?enabled=true", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldCreateBlocksByRef() throws Exception {
       ...
       http.assertRequestMade("POST", "/blocks/block_by_ref", "fixtures/client/create_blocks_by_ref_request.json", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldDoCustomNoOfRetries() {
        ...
        client = GoCardlessClient.newBuilder(ACCESS_TOKEN).withBaseUrl(http.getBaseUrl()).withMaxNoOfRetries(noOfRetries).build();
