...
public class GoCardlessClientTest {
    ...
    public void shouldListMandatesByCustomerAndStatus() throws Exception {
        ...
        http.assertRequestMade("GET", "/mandates?customer=CU00003068FG73&status=active,failed", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
    ...
    public void shouldGetCustomersCreatedAfter() throws Exception {
        ...
        http.assertRequestMade("GET", "/customers?created_at[gte]=2015-04-13T15:02:40Z", ImmutableMap.of("Authorization", "Bearer " + ACCESS_TOKEN));
    }
