...
* shown in the dashboard as the dashboard balances are updated much less frequently (once per day).
 ...
 links;
                ...
                /**
                 * The total amount in the balance, defined as the sum of all debits subtracted from the sum of all
* credits,
...
* <ul>
* <li>pending_payments_submitted: Payments we have submitted to the scheme but not yet confirmed.
* This does not exactly correspond to <i>Pending payments</i> in the dashboard, because this balance
* does not include payments that are pending submission.</li>
...
* <li>pending_payouts: Confirmed payments that have been moved into a payout. This is the total due
* to be paid into your bank account in the next payout run (payouts happen once every business day).
* pending_payouts will only be non-zero while we are generating and submitting the payouts to our
* partner bank.</li>
* </ul>
                 */
...
* "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
    ...
    
 {
            ...
            @SerializedName("confirmed_funds") CONFIRMED_FUNDS,
        
            @SerializedName("pending_payouts") PENDING_PAYOUTS,
        
            @SerializedName("pending_payments_submitted") PENDING_PAYMENTS_SUBMITTED,
