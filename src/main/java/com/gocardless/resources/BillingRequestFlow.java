...
public class BillingRequestFlow {
    ...
    /**
     * If true, the payer will be able to see redirect action buttons on Success page. These action
     * buttons will provide a way to redirect payer to the given redirect_uri.
     */
