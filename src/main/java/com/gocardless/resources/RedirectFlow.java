 ...
 * point.
 * 
 * Once you have [completed](#redirect-flows-complete-a-redirect-flow) the redirect flow
 * via the API, you should display a confirmation page to your customer, confirming that their Direct
 * Debit has been set up. You can build your own page, or redirect to the one we provide in the
 * `confirmation_url` attribute of the redirect flow.
 * 
 * Redirect flows expire 30 minutes after
 * they are first created. You cannot complete an expired redirect flow.
 */
