...
* 
* This field will only be populated if the `details[origin]` field is `api` otherwise it will be an
* empty object.
* 
                 */
 ...
 getMetadata() {
                ...
                /**
                 * The metadata of the resource that the event is for. For example, this field will have the same
* value of the `mandate[metadata]` field on the response you would receive from performing a GET
* request on a mandate.
* 
                 */
...
* </ul>
 ...
 getMandatory() {
                ...
                /**
                 * See [here](#core-endpoints-customer-notifications) for a complete list of customer notification
* types.
                 */
...
* between banks.
    ...
    
 {
            ...
            @SerializedName("gocardless") GOCARDLESS,
    ...
    
 {
            ...
            @SerializedName("sepa_cor1") SEPA_COR1,
...
* [subscription](#core-endpoints-subscriptions) which has been updated.
    ...
    
 {
            ...
            @SerializedName("gc_team") GC_TEAM,
