 ...
 * corresponding event getting included in API responses. See [here](#webhooks) for a complete list
 * of event types.
 */
public class Event {
    private Event() {
    ...
    /**
     * What has happened to the resource. See [Event Actions](#webhooks) for the possible actions.
     */
