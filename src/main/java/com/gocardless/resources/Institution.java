...
* Not all institutions support both Payment Initiation (PIS) and Account Information (AIS) services.
 ...
 autocompletesCollectBankAccount;
 ...
 status;
                ...
                /**
                 * Flag to show if selecting this institution in the select_institution action can auto-complete the
* collect_bank_account action. The bank can return the payer's bank account details to GoCardless.
                 */
 ...
 getAutocompletesCollectBankAccount() {
...
* country code 'GB' are returned by default.
    ...
    
 {
            ...
            @SerializedName("temporarily_disabled") TEMPORARILY_DISABLED,
 ...
 single;
                ...
                /**
                 * Daily limit details for this institution, in the lowest denomination for the currency (e.g. pence
* in GBP, cents in EUR). The 'limits' property is only available via an authenticated request with a
* generated access token
 ...
 getDaily() {
                ...
                /**
                 * Single transaction limit details for this institution, in the lowest denomination for the currency
* (e.g. pence in GBP, cents in EUR). The 'limits' property is only available via an authenticated
