...
* refining our API to ensure it meets your needs and provides the best experience.</p>
 ...
 getAmount() {
                ...
                /**
                 * Fixed [timestamp](#api-usage-dates-and-times), recording when the outbound payment was created.
                 */
 ...
 getCreatedAt() {
                ...
                /**
                 * [ISO 4217](http://en.wikipedia.org/wiki/ISO_4217#Active_codes) currency. Currently only "GBP" is
* supported.
                 */
...
* </ul>
 ...
 getRecipientBankAccount() {
    ...
    public static class Verifications {
        private Verifications() {
            ...
            RecipientBankAccountHolderVerification
 ...
 getRecipientBankAccountHolderVerification() {
 ...
 type;
                ...
                /**
                 * The actual account name returned by the recipient's bank, populated only in the case of a partial
* match.
                 */
...
* details.</li>
*   <li>`unable_to_match`: The verification could not be performed due to recipient bank issues or
* technical issues </li>
* </ul>
                 */
...
* Payee](https://www.wearepay.uk/what-we-do/overlay-services/confirmation-of-payee/)
    ...
    
 {
            ...
            @SerializedName("full_match") FULL_MATCH,
        
            @SerializedName("partial_match") PARTIAL_MATCH,
        
            @SerializedName("no_match") NO_MATCH,
        
            @SerializedName("unable_to_match") UNABLE_TO_MATCH,
    ...
    
 {
            ...
            @SerializedName("confirmation_of_payee") CONFIRMATION_OF_PAYEE,
