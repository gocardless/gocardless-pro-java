...
* This QR code can be used as an alternative to providing the `url` to the payer to allow them to
* authorise with their mobile devices.
                 */
...
* Defaults to `https://pay.gocardless.com/billing/static/thankyou`.
    ...
    
 {
            ...
            @SerializedName("mandate") MANDATE,
...
* for more information.
 ...
 getId() {
                ...
                /**
                 * Request for an instalment schedule. Has to contain either `instalments_with_schedule` object or an
* array of `instalments_with_dates` objects
                 */
...
* </ul>
    ...
    
 {
            ...
            @SerializedName("fulfilling") FULFILLING,
...
* - `not_needed`: we won't attempt to infer the institution as it is not needed. Either because it
* was manually selected or the billing request does not support this feature
...
>
    ...
    
 {
            ...
            @SerializedName("not_needed") NOT_NEEDED,
    ...
    
 {
            ...
            @SerializedName("collect_amount") COLLECT_AMOUNT,
            ...
            @SerializedName("confirm_payer_details") CONFIRM_PAYER_DETAILS,
        
            @SerializedName("select_institution") SELECT_INSTITUTION,
 ...
 authorisationType;
                ...
                /**
                 * Which authorisation adapter will be used to power these authorisations (GoCardless internal use
* only)
                 */
    ...
    
 {
            ...
            @SerializedName("open_banking_gateway_pis") OPEN_BANKING_GATEWAY_PIS,
        
            @SerializedName("plaid_ais") PLAID_AIS,
        
            @SerializedName("open_banking_gateway_ais") OPEN_BANKING_GATEWAY_AIS,
        
            @SerializedName("bankid_ais") BANKID_AIS,
        
            @SerializedName("bank_pay_recurring") BANK_PAY_RECURRING,
...
* `month` or `day_of_month` this will be set as the mandate's `next_possible_charge_date`
 ...
 instalmentSchedule;
                ...
                /**
                 * (Optional) ID of the [instalment_schedule](#core-endpoints-instalment-schedules) that was created
* from this instalment schedule request.
* 
                 */
 ...
 instalmentScheduleRequestInstalmentSchedule;
...
* from this instalment schedule request.
 ...
 getInstalmentScheduleRequestInstalmentSchedule() {
...
* request.
 ...
 getSubscriptionRequest() {
                ...
                /**
                 * (Optional) ID of the [subscription](#core-endpoints-subscriptions) that was created from this
* subscription request.
 ...
 getSubscriptionRequestSubscription() {
...
* signature. The dual signature flow can only be completed using GoCardless branded pages.
 ...
 getPayerRequestedDualSignature() {
...
* information.
 ...
 getAccountType() {
                ...
                /**
                 * A token to uniquely refer to a set of bank account details. This feature is still in early access
* and is only available for certain organisations.
                 */
