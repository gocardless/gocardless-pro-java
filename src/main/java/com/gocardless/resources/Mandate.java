...
* changes.
 ...
 nextPossibleStandardAchChargeDate;
...
* 
 ...
 getConsentParameters() {
                ...
                /**
                 * (Optional) Specifies the type of authorisation agreed between the payer and merchant. It can be
* set to one-off, recurring or standing for ACH, or single, recurring and sporadic for PAD.
                 */
...
* It is only present in the API response for ACH mandates.
 ...
 getNextPossibleStandardAchChargeDate() {
...
* </ul>
    ...
    
 {
            ...
            @SerializedName("standing") STANDING,
        
            @SerializedName("sporadic") SPORADIC,
