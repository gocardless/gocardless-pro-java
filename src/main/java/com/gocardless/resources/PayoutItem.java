...
* 
    ...
    
 {
            ...
            @SerializedName("refund_funds_returned") REFUND_FUNDS_RETURNED,
...
* before 2016. Present only for the items of type `payment_refunded`, `refund` and
* `refund_funds_returned`.
 ...
 getPayment() {
                ...
                /**
                 * Unique identifier, beginning with "RF". Present only for the items of type `payment_refunded`,
