...
public class SubscriptionService {
    ...
    public SubscriptionService(HttpClient httpClient) {
        ...
        /**
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your subscriptions. Please note
* if the subscriptions are related to customers who have been removed, they will not be shown in the
* response.
         */
...
* `interval_unit`. This should be a non zero positive value.
* For AUD subscriptions with `interval_unit: weekly` the minimum value varies between `3` & `4`
* because of the [mandatory minimum waiting period](#subscriptions-resume-a-subscription).
* For NZD subscriptions with `interval_unit: weekly` the minimum value is `2` because of the
