...
public class EventService {
    ...
    public EventService(HttpClient httpClient) {
        ...
        list() {
            ...
            (httpClient
                ...
                , ListRequest.<Event>pagingExecutor()
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your events.
         */
        public static final class EventListRequest
 ...
 before) {
                      ...
                      /**
                       * ID of a [billing request](#billing-requests-billing-requests). If specified, this endpoint will
* return all events for the given billing request.
                       */
...
();
                      ...
                      /**
                       * ID of an [creditor](#core-endpoints-creditors). If specified, this endpoint will return all events
* for the given creditor.
                       */
...
* </ul>
 ...
 include) {
                      ...
                      /**
                       * ID of an [instalment schedule](#core-endpoints-instalment-schedules). If specified, this endpoint
* will return all events for the given instalment schedule.
                       */
                  
                  public 
    EventListRequest<S>

                      withInstalmentSchedule(
...
* for the given mandate.
 ...
 mandate) {
                      ...
                      /**
                       * ID of an outbound_payment. If specified, this endpoint will return all events for the given
* payment.
                       */
...
* Cannot be used together with the `billing_request`, `creditor`, `export`,`instalment_schedule`,
* `mandate`, `payer_authorisation`, `payment`, `payout`, `refund`, `scheme_identifier`,
* `subscription` or `outbound_payment` parameters.
...
* </ul>
 ...
 resourceType) {
                      ...
                      /**
                       * ID of a [scheme identifier](#core-endpoints-scheme-identifiers). If specified, this endpoint will
* return all events for the given scheme identifier.
                       */
                  
                  public 
    EventListRequest<S>

                      withSchemeIdentifier(
...
* events for the given subscription.
 ...
 subscription) {
          ...
          private EventListRequest(HttpClient httpClient
                  ...
                  , ListRequestExecutor<S, Event> executor
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum Include {
            ...
            @SerializedName("billing_request") BILLING_REQUEST
        
            ,@SerializedName("creditor") CREDITOR
        
            ,@SerializedName("instalment_schedule") INSTALMENT_SCHEDULE
        
            ,@SerializedName("mandate") MANDATE
        
            ,@SerializedName("outbound_payment") OUTBOUND_PAYMENT
        
            ,@SerializedName("payer_authorisation") PAYER_AUTHORISATION
            ...
            ,@SerializedName("scheme_identifier") SCHEME_IDENTIFIER
    ...
    public enum ResourceType {
            ...
            @SerializedName("billing_requests") BILLING_REQUESTS
        
            ,@SerializedName("creditors") CREDITORS
        
            ,@SerializedName("exports") EXPORTS
        
            ,@SerializedName("instalment_schedules") INSTALMENT_SCHEDULES
        
            ,@SerializedName("mandates") MANDATES
        
            ,@SerializedName("organisations") ORGANISATIONS
        
            ,@SerializedName("outbound_payments") OUTBOUND_PAYMENTS
        
            ,@SerializedName("payer_authorisations") PAYER_AUTHORISATIONS
        
            ,@SerializedName("payments") PAYMENTS
        
            ,@SerializedName("payouts") PAYOUTS
        
            ,@SerializedName("refunds") REFUNDS
        
            ,@SerializedName("scheme_identifiers") SCHEME_IDENTIFIERS
        
            ,@SerializedName("subscriptions") SUBSCRIPTIONS
