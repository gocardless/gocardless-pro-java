...
public class PayoutService {
    ...
    public PayoutService(HttpClient httpClient) {
        ...
        list() {
            return new PayoutListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<Payout>pagingExecutor()
...
* payout, see [this guide](#events-reconciling-payouts-with-events).
         ...
         */
        public PayoutUpdateRequest
        
        update(String identity) {
            return new PayoutUpdateRequest
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your payouts.
         */
        public static final class PayoutListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Payout>
         {
...
* values up to 500 characters. _Note:_ This should not be used for storing PII data.
 ...
 reference) {
                       ...
                       * One of:
* <ul>
* <li>`pending`: the payout has been created, but not yet sent to your bank or it is in the process
* of being exchanged through our FX provider.</li>
* <li>`paid`: the payout has been sent to the your bank. FX payouts will become `paid` after we emit
* the `fx_rate_confirmed` webhook.</li>
...
* </ul>
 ...
 status) {
          ...
          private PayoutListRequest(HttpClient httpClient
                  ...
                  , ListRequestExecutor<S, Payout> executor
...
* values up to 500 characters.
    ...
    PayoutUpdateRequest
          ...
          private PayoutUpdateRequest(HttpClient httpClient
