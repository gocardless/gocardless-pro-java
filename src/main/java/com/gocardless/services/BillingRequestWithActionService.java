...
* such as collecting customer details, bank account details, or other required actions.
         */
        public BillingRequestWithActionCreateWithActionsRequest
        
        createWithActions() {
            return new BillingRequestWithActionCreateWithActionsRequest
...
* such as collecting customer details, bank account details, or other required actions.
        ...
        extends
            ...
            PostRequest<BillingRequestWithAction>
         {
 ...
 purposeCode;
                  ...
                  public 
    BillingRequestWithActionCreateWithActionsRequest
 ...
 actions) {
    ...
    BillingRequestWithActionCreateWithActionsRequest
                                  ...
                                  withActionsBankAuthorisationRedirectUri(
                                      
    
        String
    
 bankAuthorisationRedirectUri
                                  ) {
                                  if (actions == null) {
                                      actions = new 
...
();
    ...
    BillingRequestWithActionCreateWithActionsRequest
                                  ...
                                  withActionsCollectCustomerDetails(
...
();
    ...
    BillingRequestWithActionCreateWithActionsRequest
                                  ...
                                  withActionsConfirmPayerDetails(
...
();
    ...
    BillingRequestWithActionCreateWithActionsRequest
                                  ...
                                  withActionsCreateBankAuthorisation(
...
* account token](#javascript-flow-customer-bank-account-tokens).
            ...
            public CollectBankAccount withAccountHolderName(
...
* Alternatively you can provide an `iban`.
            ...
            public CollectBankAccount withAccountNumber(
...
* details](#local-bank-details-new-zealand) for more information.
            ...
            public CollectBankAccount withAccountNumberSuffix(
...
* you can provide an `iban`.
            ...
            public CollectBankAccount withBankCode(
...
* Alternatively you can provide an `iban`.
            ...
            public CollectBankAccount withBranchCode(
...
* to the country code of the `iban` if supplied, otherwise is required.
            ...
            public CollectBankAccount withCountryCode(
...
* "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
            ...
            public CollectBankAccount withCurrency(
...
* denominated in SEK - you must supply [local details](#local-bank-details-sweden).
            ...
            public CollectBankAccount withIban(
...
* values up to 500 characters.
            ...
            public CollectBankAccount withMetadata(
...
* make and accept payments.
            ...
            public CollectBankAccount withPayId(
...
* denominated in Swedish krona (SEK). This field cannot be changed once it has been set.
            ...
            public Map<String, Object> getQueryParams() {
                ImmutableMap.Builder<String, Object> params = ImmutableMap.builder();
                    ...
                    if (danishIdentityNumber != null) {
                        params.put("customer_billing_detail[danish_identity_number]", danishIdentityNumber);
                    }
                    ...
                    if (swedishIdentityNumber != null) {
                        params.put("customer_billing_detail[swedish_identity_number]", swedishIdentityNumber);
                    }
 ...
 customerBillingDetail;
            ...
            public CollectCustomerDetails withCustomer(
            ...
            public Map<String, Object> getQueryParams() {
                ImmutableMap.Builder<String, Object> params = ImmutableMap.builder();
                    ...
                    if (customerBillingDetail != null) {
                        params.put("collect_customer_details[customer_billing_detail]", customerBillingDetail);
                    }
...
* values up to 500 characters.
            ...
            public ConfirmPayerDetails withMetadata(
            ...
            public Map<String, Object> getQueryParams() {
                ImmutableMap.Builder<String, Object> params = ImmutableMap.builder();
                    ...
                    if (payerRequestedDualSignature != null) {
                        params.put("confirm_payer_details[payer_requested_dual_signature]", payerRequestedDualSignature);
                    }
...
* country code 'GB' are returned by default.
            ...
            public SelectInstitution withCountryCode(
 ...
 countryCode) {
            ...
            public SelectInstitution withInstitution(
 ...
 selectInstitution;
            ...
            public Actions withBankAuthorisationRedirectUri(
 ...
 bankAuthorisationRedirectUri) {
            ...
            public Actions withCollectBankAccount(
 ...
 collectCustomerDetails) {
            ...
            public Actions withConfirmPayerDetails(
 ...
 confirmPayerDetails) {
            ...
            public Actions withCreateBankAuthorisation(
 ...
 createBankAuthorisation) {
            ...
            public Actions withSelectInstitution(
