...
* If you attempt to go over this limit, the API will return a `record_limit_exceeded` error.
         */
        public MandateImportEntryCreateRequest
        
        create() {
            return new MandateImportEntryCreateRequest
...
* 
         */
        public MandateImportEntryListRequest
        
            <ListResponse<MandateImportEntry>>
        
        list() {
            return new MandateImportEntryListRequest
            ...
            public MandateImportEntryListRequest<Iterable<MandateImportEntry>> all() {
                return new MandateImportEntryListRequest<>(httpClient, ListRequest.<MandateImportEntry>iteratingExecutor()
...
* If you attempt to go over this limit, the API will return a `record_limit_exceeded` error.
 ...
 recordIdentifier;
                  ...
                  public 
    MandateImportEntryCreateRequest
...
* 
    ...
    MandateImportEntryCreateRequest
                                  ...
                                  withAmendmentOriginalCreditorId(
...
* 
    ...
    MandateImportEntryCreateRequest
                                  ...
                                  withAmendmentOriginalCreditorName(
...
* 
    ...
    MandateImportEntryCreateRequest
                                  ...
                                  withAmendmentOriginalMandateReference(
...
* 
            ...
            public Amendment withOriginalCreditorId(
...
* 
            ...
            public Amendment withOriginalCreditorName(
...
* 
            ...
            public Amendment withOriginalMandateReference(
...
* denominated in Swedish krona (SEK). This field cannot be changed once it has been set.
 ...
 mandateImport;
            ...
            public Links withMandateImport(
...
* 
 ...
 status;
                  ...
                  public 
    MandateImportEntryListRequest<S>
 ...
 mandateImport) {
                       ...
                       * One of:
* <ul>
* <li>`sucessfully_processed`: the entry has been imported and the associated records created.</li>
...
* </ul>
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum Status {
            ...
            @SerializedName("successfully_processed") SUCCESSFULLY_PROCESSED
        
            ,@SerializedName("unsuccessfully_processed") UNSUCCESSFULLY_PROCESSED
