...
*   These endpoints are restricted to customers who want to collect their merchant's
*   verification details and pass them to GoCardless via our API. Please [get in
*   touch](mailto:help@gocardless.com) if you wish to enable this feature on your
*   account.</p>
 */
public class VerificationDetailService {
    ...
    public VerificationDetailService(HttpClient httpClient) {
         ...
         */
        public VerificationDetailCreateRequest
        
        create() {
            return new VerificationDetailCreateRequest
         ...
         */
        public VerificationDetailListRequest
        
            <ListResponse<VerificationDetail>>
        
        list() {
            return new VerificationDetailListRequest
            ...
            public VerificationDetailListRequest<Iterable<VerificationDetail>> all() {
                return new VerificationDetailListRequest<>(httpClient, ListRequest.<VerificationDetail>iteratingExecutor()
        ...
        extends
            ...
            PostRequest<VerificationDetail>
         {
...
* code.](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements)
            ...
            public Directors withCountryCode(
 ...
 countryCode) {
            ...
            public Directors withDateOfBirth(
 ...
 dateOfBirth) {
            ...
            public Directors withFamilyName(
 ...
 familyName) {
            ...
            public Directors withGivenName(
 ...
 givenName) {
            ...
            public Directors withPostalCode(
 ...
 creditor) {
         ...
         *
          * Returns a list of verification details belonging to a creditor.
         */
        public static final class VerificationDetailListRequest
        
            <S>
        
        extends
        
            ListRequest<S, VerificationDetail>
         {
 ...
 creditor;
                  ...
                  public 
    VerificationDetailListRequest<S>
