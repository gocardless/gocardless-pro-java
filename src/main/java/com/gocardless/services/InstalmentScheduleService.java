...
* failures.
         */
        public InstalmentScheduleCreateWithDatesRequest
        
        createWithDates() {
            return new InstalmentScheduleCreateWithDatesRequest
...
* failures.
         ...
         */
        public InstalmentScheduleListRequest
        
            <ListResponse<InstalmentSchedule>>
        
        list() {
            return new InstalmentScheduleListRequest
            ...
            public InstalmentScheduleListRequest<Iterable<InstalmentSchedule>> all() {
                return new InstalmentScheduleListRequest<>(httpClient, ListRequest.<InstalmentSchedule>iteratingExecutor()
         ...
         */
        public InstalmentScheduleGetRequest
        
        get(String identity) {
            return new InstalmentScheduleGetRequest
         ...
         */
        public InstalmentScheduleUpdateRequest
        
        update(String identity) {
            return new InstalmentScheduleUpdateRequest
...
* or has completed.
         */
        public InstalmentScheduleCancelRequest
        
        cancel(String identity) {
            return new InstalmentScheduleCancelRequest
...
* <strong>Betalingsservice</strong> - 30 characters<br /> <strong>Faster Payments</strong> - 18
* characters<br /> <strong>PAD</strong> - scheme doesn't offer references<br />
* <strong>PayTo</strong> - 18 characters<br /> <strong>SEPA</strong> - 140 characters<br /> Note
* that this reference must be unique (for each merchant) for the BECS scheme as it is a scheme
* requirement. <p class='restricted-notice'><strong>Restricted</strong>: You can only specify a
* payment reference for Bacs payments (that is, when collecting from the UK) if you're on the <a
* href='https://gocardless.com/pricing'>GoCardless Plus, Pro or Enterprise packages</a>.</p> <p
* class='restricted-notice'><strong>Restricted</strong>: You can not specify a payment reference for
* Faster Payments.</p>
                       */
...
* forwards to that date.
            ...
            public Instalments withChargeDate(
...
* [compliance requirements](#appendix-compliance-requirements)).
            ...
            public Instalments withDescription(
...
* 
            ...
            public Instalments withAmounts(
...
* 
            ...
            public Instalments withInterval(
 ...
 interval) {
            ...
            public Instalments withIntervalUnit(
...
* `month` or `day_of_month` this will be set as the mandate's `next_possible_charge_date`
            ...
            public Instalments withStartDate(
...
>
 ...
 status;
                  ...
                  public 
    InstalmentScheduleListRequest<S>
...
>
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum Status {
            ...
            ,@SerializedName("creation_failed") CREATION_FAILED
 ...
 lte) {
        ...
        extends
            ...
            GetRequest<InstalmentSchedule>
         {
          ...
          private InstalmentScheduleGetRequest(HttpClient httpClient
...
* values up to 500 characters.
                  ...
                  public 
    InstalmentScheduleUpdateRequest
...
* values up to 500 characters.
    ...
    InstalmentScheduleUpdateRequest
          ...
          private InstalmentScheduleUpdateRequest(HttpClient httpClient
...
* or has completed.
        ...
        extends
            ...
            PostRequest<InstalmentSchedule>
         {
          ...
          private InstalmentScheduleCancelRequest(HttpClient httpClient
              ...
              public 
    InstalmentScheduleCancelRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
