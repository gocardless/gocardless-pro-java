...
public class MandateService {
    ...
    public MandateService(HttpClient httpClient) {
         ...
         */
        public MandateListRequest
        
            <ListResponse<Mandate>>
        
        list() {
            return new MandateListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<Mandate>pagingExecutor()
         ...
         */
        public MandateGetRequest
        
        get(String identity) {
            return new MandateGetRequest
         ...
         */
        public MandateUpdateRequest
        
        update(String identity) {
            return new MandateUpdateRequest
...
* Mandates can be resubmitted up to 10 times.
         */
        public MandateReinstateRequest
        
        reinstate(String identity) {
            return new MandateReinstateRequest
...
* satisfying the different scheme requirements if this field is left blank.
 ...
 reference) {
                      ...
                      /**
                       * <a name="mandates_scheme"></a>Bank payment scheme to which this mandate and associated payments
...
* mandate is created and submits payments against.
 ...
 customerBankAccount) {
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your mandates.
         */
        public static final class MandateListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Mandate>
         {
...
>
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum Status {
            ...
            ,@SerializedName("suspended_by_payer") SUSPENDED_BY_PAYER
...
* values up to 500 characters.
    ...
    MandateUpdateRequest
          ...
          private MandateUpdateRequest(HttpClient httpClient
...
* values up to 500 characters.
    ...
    MandateCancelRequest
          ...
          private MandateCancelRequest(HttpClient httpClient
...
* values up to 500 characters.
    ...
    MandateReinstateRequest
          ...
          private MandateReinstateRequest(HttpClient httpClient
