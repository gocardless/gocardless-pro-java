...
public class BillingRequestService {
    ...
    /**
     * This endpoint allows you to create a billing request and complete any required actions in a
     * single request.
     */
    public BillingRequestCreateWithActionsRequest createWithActions() {
        return new BillingRequestCreateWithActionsRequest(httpClient);
    }
    ...
    /**
     * Request class for {@link BillingRequestService#createWithActions }.
     *
     * This endpoint allows you to create a billing request and complete any required actions in a
     * single request.
     */
    public static final class BillingRequestCreateWithActionsRequest
            extends IdempotentPostRequest<BillingRequest> {
         ...
         */
        public BillingRequestCreateWithActionsRequest withActions(Actions actions) {
         ...
         */
        public BillingRequestCreateWithActionsRequest withActionsBankAuthorisationRedirectUri(
         ...
         */
        public BillingRequestCreateWithActionsRequest withActionsCollectBankAccount(
         ...
         */
        public BillingRequestCreateWithActionsRequest withActionsCollectCustomerDetails(
        ...
        /**
         * By default, we will auto confirm the payer details when this endpoint is used for
         * relevant billing requests. You can skip this parameter entirely if you don't need to
         * specify dual signatory or metadata. The assumption is that you have already adhered to
         * your compliance requirements of confirming these details with the payer before calling
         * this endpoint. Please refer to the confirm_payer_details endpoint for more information.
         */
        public BillingRequestCreateWithActionsRequest withActionsConfirmPayerDetails(
        ...
        /**
         * For instant payments, pass this boolean in order to create a bank authorisation link that
         * payer's can use to authorise the payment. By default this is considered false.
         */
        public BillingRequestCreateWithActionsRequest withActionsCreateBankAuthorisation(
         ...
         */
        public BillingRequestCreateWithActionsRequest withActionsSelectInstitution(
         ...
         * for more information.
         */
        public BillingRequestCreateWithActionsRequest withFallbackEnabled(Boolean fallbackEnabled) {
            this.fallbackEnabled = fallbackEnabled;
            return this;
        }

        public BillingRequestCreateWithActionsRequest withLinks(Links links) {
            this.links = links;
            return this;
        }
         ...
         * manages multiple creditors.
         */
        public BillingRequestCreateWithActionsRequest withLinksCreditor(String creditor) {
            if (links == null) {
                links = new Links();
            }
            links.withCreditor(creditor);
         ...
         * made.
         */
        public BillingRequestCreateWithActionsRequest withLinksCustomer(String customer) {
            if (links == null) {
                links = new Links();
            }
            links.withCustomer(customer);
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withLinksCustomerBankAccount(
                String customerBankAccount) {
            if (links == null) {
                links = new Links();
            }
        ...
        /**
         * Supports all the same params as the standalone CREATE billing request endpoint.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequest(
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestAuthorisationSource(
                MandateRequest.AuthorisationSource authorisationSource) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
         ...
         * VRP.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestConstraints(
         ...
         * [ISO 4217](http://en.wikipedia.org/wiki/ISO_4217#Active_codes) currency code.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestCurrency(String currency) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
            mandateRequest.withCurrency(currency);
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestDescription(
                String description) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
         ...
         * characters and values up to 500 characters.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestMetadata(
                Map<String, String> metadata) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
         ...
         * satisfying the different scheme requirements if this field is left blank.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestReference(
                String reference) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
         ...
         * currency/scheme to pay with from a list of your available schemes.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestScheme(String scheme) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
            mandateRequest.withScheme(scheme);
         ...
         * also owns. This is required for Faster Payments
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestSweeping(Boolean sweeping) {
            if (mandateRequest == null) {
                mandateRequest = new MandateRequest();
            }
            mandateRequest.withSweeping(sweeping);
         ...
         * for more information.
         */
        public BillingRequestCreateWithActionsRequest withMandateRequestVerify(
         ...
         * characters and values up to 500 characters.
         */
        public BillingRequestCreateWithActionsRequest withMetadata(Map<String, String> metadata) {
            this.metadata = metadata;
            return this;
        }
         ...
         * characters and values up to 500 characters.
         */
        public BillingRequestCreateWithActionsRequest withMetadata(String key, String value) {
            if (metadata == null) {
                metadata = new HashMap<>();
            }
            metadata.put(key, value);
         ...
         * Supports all the same params as the standalone CREATE billing request endpoint.
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequest(
         ...
         * Amount in minor unit (e.g. pence in GBP, cents in EUR).
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestAmount(Integer amount) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
            paymentRequest.withAmount(amount);
         ...
         * currency (e.g. pence in GBP, cents in EUR).
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestAppFee(Integer appFee) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
            paymentRequest.withAppFee(appFee);
         ...
         * supported Eurozone countries only.
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestCurrency(String currency) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
            paymentRequest.withCurrency(currency);
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestDescription(
                String description) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestFundsSettlement(
                PaymentRequest.FundsSettlement fundsSettlement) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
         ...
         * characters and values up to 500 characters.
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestMetadata(
                Map<String, String> metadata) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestReference(
                String reference) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
         ...
         * </p>
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestRetryIfPossible(
                Boolean retryIfPossible) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
         ...
         * `sepa_instant_credit_transfer` may incur an additional fee for your customer.
         */
        public BillingRequestCreateWithActionsRequest withPaymentRequestScheme(String scheme) {
            if (paymentRequest == null) {
                paymentRequest = new PaymentRequest();
            }
            paymentRequest.withScheme(scheme);
         ...
         * `government`, `pension`, `tax` and `other` are supported.
         */
        public BillingRequestCreateWithActionsRequest withPurposeCode(PurposeCode purposeCode) {
            this.purposeCode = purposeCode;
            return this;
        }
         ...
         * Supports all the same params as the standalone CREATE billing request endpoint.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequest(
                SubscriptionRequest subscriptionRequest) {
            this.subscriptionRequest = subscriptionRequest;
            return this;
        }
         ...
         * Amount in the lowest denomination for the currency (e.g. pence in GBP, cents in EUR).
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestAmount(
                Integer amount) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * (e.g. pence in GBP, cents in EUR).
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestAppFee(
                Integer appFee) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * The total number of payments that should be taken by this subscription.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestCount(Integer count) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
            subscriptionRequest.withCount(count);
         ...
         * "AUD", "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestCurrency(
                String currency) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * indicate the last day of the month.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestDayOfMonth(
                Integer dayOfMonth) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * to `1`. Must result in at least one charge date per year. Defaults to `1`.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestInterval(
                Integer interval) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * The unit of time between customer charge dates. One of `weekly`, `monthly` or `yearly`.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestIntervalUnit(
                SubscriptionRequest.IntervalUnit intervalUnit) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * characters and values up to 500 characters.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestMetadata(
                Map<String, String> metadata) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestMonth(
                SubscriptionRequest.Month month) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * created. Must not exceed 255 characters.
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestName(String name) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
            subscriptionRequest.withName(name);
         ...
         * payment endpoint](#payments-create-a-payment) for more details. <br />
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestPaymentReference(
                String paymentReference) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * </p>
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestRetryIfPossible(
                Boolean retryIfPossible) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
         ...
         * 
         */
        public BillingRequestCreateWithActionsRequest withSubscriptionRequestStartDate(
                String startDate) {
            if (subscriptionRequest == null) {
                subscriptionRequest = new SubscriptionRequest();
            }
        ...
        public BillingRequestCreateWithActionsRequest withIdempotencyKey(String idempotencyKey) {
            super.setIdempotencyKey(idempotencyKey);
            return this;
        }
        ...
        private BillingRequestCreateWithActionsRequest(HttpClient httpClient) {
            super(httpClient);
        }

        public BillingRequestCreateWithActionsRequest withHeader(String headerName,
                String headerValue) {
            this.addHeader(headerName, headerValue);
            return this;
        }
        ...
        public static class Actions {
             ...
             * By default, we will auto confirm the payer details when this endpoint is used for
             * relevant billing requests. You can skip this parameter entirely if you don't need to
             * specify dual signatory or metadata. The assumption is that you have already adhered
             * to your compliance requirements of confirming these details with the payer before
             * calling this endpoint. Please refer to the confirm_payer_details endpoint for more
             * information.
             */
            ...
            /**
             * For instant payments, pass this boolean in order to create a bank authorisation link
             * that payer's can use to authorise the payment. By default this is considered false.
             */
