...
* how-to's, explanations and tutorials. <p class="notice"><strong>Important</strong>: All properties
* associated with `subscription_request` and `instalment_schedule_request` are only supported for
...
public class BillingRequestService {
     ...
     * of this class can be obtained by calling
      {@link com.gocardless.GoCardlessClient#billingRequests() }.
     */
...
* `subscription_request` and `instalment_schedule_request` are only supported for ACH and PAD
* schemes.</p>
         */
        public BillingRequestCreateRequest
        
        create() {
            return new BillingRequestCreateRequest
...
* successful.
        ...
        collectCustomerDetails(String identity) {
            return new BillingRequestCollectCustomerDetailsRequest
...
* and attaching it.
* 
* If the scheme is PayTo and the pay_id is available, this can be included in the payload along with
* the
* country_code.
* 
...
* is enabled by default for UK based bank accounts, meaning we verify the account holder name and
* bank account
* number match the details held by the relevant bank.
         */
        public BillingRequestCollectBankAccountRequest
        
        collectBankAccount(String identity) {
            return new BillingRequestCollectBankAccountRequest
...
* allow the payer to crosscheck the details entered by them and confirm it.
         */
        public BillingRequestConfirmPayerDetailsRequest
        
        confirmPayerDetails(String identity) {
            return new BillingRequestConfirmPayerDetailsRequest
...
* it to fulfil, executing the payment.
         */
        public BillingRequestFulfilRequest
        
        fulfil(String identity) {
            return new BillingRequestFulfilRequest
...
* to expire.
         */
        public BillingRequestCancelRequest
        
        cancel(String identity) {
            return new BillingRequestCancelRequest
         ...
         */
        public BillingRequestListRequest
        
            <ListResponse<BillingRequest>>
        
        list() {
            return new BillingRequestListRequest
            ...
            public BillingRequestListRequest<Iterable<BillingRequest>> all() {
                return new BillingRequestListRequest<>(httpClient, ListRequest.<BillingRequest>iteratingExecutor()
         ...
         */
        public BillingRequestGetRequest
        
        get(String identity) {
            return new BillingRequestGetRequest
...
* This endpoint is currently supported only for Instant Bank Pay Billing Requests.
         */
        public BillingRequestNotifyRequest
        
        notify(String identity) {
            return new BillingRequestNotifyRequest
        ...
        /**
          * Triggers a fallback from the open-banking flow to direct debit. Note, the billing request must
* have fallback enabled.
         */
        public BillingRequestFallbackRequest
        
        fallback(String identity) {
            return new BillingRequestFallbackRequest
...
* will also not support any request which has a payments request.
         */
        public BillingRequestChooseCurrencyRequest
        
        chooseCurrency(String identity) {
            return new BillingRequestChooseCurrencyRequest
         ...
         */
        public BillingRequestSelectInstitutionRequest
        
        selectInstitution(String identity) {
            return new BillingRequestSelectInstitutionRequest
...
();
                                  ...
                                  /**
                                    * [ISO 4217](http://en.wikipedia.org/wiki/ISO_4217#Active_codes) currency code. Currently "USD" and
* "CAD" are supported.
                                   */
    ...
    BillingRequestCreateRequest
                                  ...
                                  withInstalmentScheduleRequestCurrency(
...
* See [create (with dates)](#instalment-schedules-create-with-dates)
                                   */
                              
                              public 
    BillingRequestCreateRequest

                                  withInstalmentScheduleRequestInstalmentsWithDates(
...
* 
    ...
    BillingRequestCreateRequest
                                  ...
                                  withInstalmentScheduleRequestInstalmentsWithSchedule(
                                      
    
        InstalmentsWithSchedule
...
* copied to the payments of the instalment schedule if you use schedule-based creation.
    ...
    BillingRequestCreateRequest
                                  ...
                                  withInstalmentScheduleRequestName(
...
* <br />
    ...
    BillingRequestCreateRequest
                                  ...
                                  withInstalmentScheduleRequestPaymentReference(
...
* class="notice"><strong>Important</strong>: To be able to use intelligent retries, Success+ needs
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p>
                                   */
...
();
                                  ...
                                  /**
                                    * ID of the [customer](#core-endpoints-customers) against which this request should be made.
                                   */
...
();
                                  ...
                                  /**
                                    * (Optional) ID of the [customer_bank_account](#core-endpoints-customer-bank-accounts) against which
...
*   paper: Authorisation is provided in writing and signed, or similarly authenticated (maps to SEC
* code: PPD)
* 
                                   */
    ...
    BillingRequestCreateRequest
                                  ...
                                  withMandateRequestAuthorisationSource(
                                      MandateRequest.
...
();
                                  ...
                                  /**
                                    * This attribute represents the authorisation type between the payer and merchant. It can be set to
* `one_off`,
* `recurring` or `standing` for ACH scheme. And `single`, `recurring` and `sporadic` for PAD scheme.
* _Note:_ This is only supported for ACH and PAD schemes.
* 
                                   */
...
();
                                  ...
                                  /**
                                    * Constraints that will apply to the mandate_request. (Optional) Specifically required for PayTo and
* VRP.
                                   */
...
();
                                  ...
                                  /**
                                    * A human-readable description of the payment and/or mandate. This will be displayed to the payer
* when authorising the billing request.
* 
                                   */
...
* "faster_payments", "pad", "pay_to" and "sepa_core" are supported. Optional for mandate only
* requests - if left blank, the payer will be able to select the currency/scheme to pay with from a
...
();
                                  ...
                                  /**
                                    * If true, this billing request would be used to set up a mandate solely for moving (or sweeping)
* money from one account owned by the payer to another account that the payer also owns. This is
...
*   <li>`recommended`: in addition to `minimum`, use the GoCardless payment intelligence solution to
* decide if a payer should be verified</li>
*   <li>`when_available`: if verification mechanisms are available, use them</li>
*   <li>`always`: as `when_available`, but fail to create the Billing Request if a mechanism isn't
* available</li>
* </ul>
* 
* By default, all Billing Requests use the `recommended` verification preference. It uses GoCardless
* payment intelligence solution to determine if a payer is fraudulent or not. The verification
* mechanism is based on the response and the payer may be asked to verify themselves. If the feature
* is not available, `recommended` behaves like `minimum`.
* 
* If you never wish to take advantage of our reduced risk products and Verified Mandates as they are
* released in new schemes, please use the `minimum` verification preference.
* 
...
();
                                  ...
                                  /**
                                    * The amount to be deducted from the payment as an app fee, to be paid to the partner integration
* which created the billing request, in the lowest denomination for the currency (e.g. pence in GBP,
* cents in EUR).
                                   */
...
* 
    ...
    BillingRequestCreateRequest
                                  ...
                                  withPaymentRequestFundsSettlement(
                                      PaymentRequest.
...
();
                                  ...
                                  /**
                                    * A custom payment reference defined by the merchant. It is only available for payments on the PayTo
* scheme or payments using the Direct Funds settlement model on the Faster Payments scheme.
* 
                                   */
...
* retries](#success-intelligent-retries). Default is `false`. <p
* class="notice"><strong>Important</strong>: To be able to use intelligent retries, Success+ needs
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p> <p
* class="notice"><strong>Important</strong>: This is not applicable to IBP and VRP payments. </p>
                                   */
...
();
                                  ...
                                  /**
                                    * (Optional) A scheme used for Open Banking payments. Currently `faster_payments` is supported in
* the UK (GBP) and `sepa_credit_transfer` and `sepa_instant_credit_transfer` are supported in
* supported Eurozone countries (EUR). For Eurozone countries, `sepa_credit_transfer` is used as the
* default. Please be aware that `sepa_instant_credit_transfer` may incur an additional fee for your
* customer.
                                   */
...
* `utility`, `loan`, `dependant_support`, `gambling`, `retail`, `salary`, `personal`, `government`,
* `pension`, `tax` and `other` are supported.
                       */
...
* "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestCurrency(
...
* last day of the month.
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestDayOfMonth(
...
* Must result in at least one charge date per year. Defaults to `1`.
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestInterval(
...
();
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestIntervalUnit(
                                      SubscriptionRequest.
...
* values up to 500 characters.
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestMetadata(
...
* <br />
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestPaymentReference(
...
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p>
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestRetryIfPossible(
...
();
                                  ...
                                  /**
                                    * The date on which the first payment should be charged. If fulfilled after this date, this will be
* set as the mandate's `next_possible_charge_date`.
* When left blank and `month` or `day_of_month` are provided, this will be set to the date of the
* first payment.
* If created without `month` or `day_of_month` this will be set as the mandate's
...
* 
    ...
    BillingRequestCreateRequest
                                  ...
                                  withSubscriptionRequestStartDate(
...
();
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum PurposeCode {
            ...
            ,@SerializedName("dependant_support") DEPENDANT_SUPPORT
        
            ,@SerializedName("gambling") GAMBLING
        
            ,@SerializedName("retail") RETAIL
        
            ,@SerializedName("salary") SALARY
        
            ,@SerializedName("personal") PERSONAL
        
            ,@SerializedName("government") GOVERNMENT
        
            ,@SerializedName("pension") PENSION
        
            ,@SerializedName("tax") TAX
        
            ,@SerializedName("other") OTHER
        
            ,@SerializedName("Epayment") EPAYMENT
        
            ,@SerializedName("Commercial") COMMERCIAL
        
            ,@SerializedName("OtherPayment") OTHERPAYMENT
 ...
 description;
            ...
            public InstalmentsWithDates withAmount(
...
* forwards to that date.
            ...
            public InstalmentsWithDates withChargeDate(
...
* [compliance requirements](#appendix-compliance-requirements)).
            ...
            public InstalmentsWithDates withDescription(
...
* 
            ...
            public InstalmentsWithSchedule withAmounts(
...
* 
            ...
            public InstalmentsWithSchedule withInterval(
 ...
 interval) {
            ...
            public InstalmentsWithSchedule withIntervalUnit(
...
* `month` or `day_of_month` this will be set as the mandate's `next_possible_charge_date`
            ...
            public InstalmentsWithSchedule withStartDate(
...
* cents in EUR).
            ...
            public InstalmentScheduleRequest withAppFee(
...
* "CAD" are supported.
            ...
            public InstalmentScheduleRequest withCurrency(
...
* values up to 500 characters.
            ...
            public InstalmentScheduleRequest withMetadata(
...
* copied to the payments of the instalment schedule if you use schedule-based creation.
            ...
            public InstalmentScheduleRequest withName(
...
* <br />
            ...
            public InstalmentScheduleRequest withPaymentReference(
...
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p>
            ...
            public InstalmentScheduleRequest withRetryIfPossible(
...
* will be returned.
            ...
            public InstalmentScheduleRequest withTotalAmount(
...
* 
            ...
            public Links withCustomerBankAccount(
...
* 
* `calendar` - this will finish on the end of the current period. For example this will expire on
* the Monday for the current week or the January for the next year.
* 
* `creation_date` - this will finish on the next instance of the current period. For example Monthly
* it will expire on the same day of the next month, or yearly the same day of the next year.
* 
                 */
            
            public PeriodicLimits withAlignment(
 ...
 alignment) {
            ...
            public PeriodicLimits withMaxPayments(
...
* 
            ...
            public PeriodicLimits withMaxTotalAmount(
 ...
 maxTotalAmount) {
            ...
            public PeriodicLimits withPeriod(
 ...
 period) {
    ...
    public enum Alignment {
            ...
            @SerializedName("calendar") CALENDAR
        
            ,@SerializedName("creation_date") CREATION_DATE
...
* 
* This is an optional field and if it is not supplied the agreement will be considered open and
* will not have an end date. Keep in mind the end date must take into account how long it will
* take the user to set up this agreement via the Billing Request.
* 
                 */
            
            public Constraints withEndDate(
 ...
 endDate) {
            ...
            public Constraints withMaxAmountPerPayment(
 ...
 maxAmountPerPayment) {
                ...
                /**
                 * A constraint where you can specify info (free text string) about how payments are calculated.
* _Note:_ This is only supported for ACH and PAD schemes.
* 
                 */
            
            public Constraints withPaymentMethod(
 ...
 paymentMethod) {
            ...
            public Constraints withPeriodicLimits(
...
* 
            ...
            public Constraints withStartDate(
...
* 
            ...
            public MandateRequest withAuthorisationSource(
...
* 
            ...
            public MandateRequest withConsentType(
...
* VRP.
            ...
            public MandateRequest withConstraints(
 ...
 constraints) {
            ...
            public MandateRequest withCurrency(
...
* 
            ...
            public MandateRequest withDescription(
...
* values up to 500 characters.
            ...
            public MandateRequest withMetadata(
...
* satisfying the different scheme requirements if this field is left blank.
            ...
            public MandateRequest withReference(
...
* list of your available schemes.
            ...
            public MandateRequest withScheme(
...
* required for Faster Payments
            ...
            public MandateRequest withSweeping(
...
* for more information.
            ...
            public MandateRequest withVerify(
 ...
 verify) {
    ...
    public enum Verify {
            ...
            @SerializedName("minimum") MINIMUM
        
            ,@SerializedName("recommended") RECOMMENDED
        
            ,@SerializedName("when_available") WHEN_AVAILABLE
 ...
 scheme;
            ...
            public PaymentRequest withAmount(
...
* cents in EUR).
            ...
            public PaymentRequest withAppFee(
...
* Eurozone countries only.
            ...
            public PaymentRequest withCurrency(
...
* 
            ...
            public PaymentRequest withDescription(
...
* 
            ...
            public PaymentRequest withFundsSettlement(
...
* values up to 500 characters.
            ...
            public PaymentRequest withMetadata(
...
* 
            ...
            public PaymentRequest withReference(
...
* class="notice"><strong>Important</strong>: This is not applicable to IBP and VRP payments. </p>
            ...
            public PaymentRequest withRetryIfPossible(
...
* customer.
            ...
            public PaymentRequest withScheme(
 ...
 startDate;
            ...
            public SubscriptionRequest withAmount(
...
* cents in EUR).
            ...
            public SubscriptionRequest withAppFee(
 ...
 appFee) {
            ...
            public SubscriptionRequest withCount(
...
* "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
            ...
            public SubscriptionRequest withCurrency(
...
* last day of the month.
            ...
            public SubscriptionRequest withDayOfMonth(
...
* Must result in at least one charge date per year. Defaults to `1`.
            ...
            public SubscriptionRequest withInterval(
 ...
 interval) {
            ...
            public SubscriptionRequest withIntervalUnit(
...
* values up to 500 characters.
            ...
            public SubscriptionRequest withMetadata(
...
* 
            ...
            public SubscriptionRequest withMonth(
...
* Must not exceed 255 characters.
            ...
            public SubscriptionRequest withName(
...
* <br />
            ...
            public SubscriptionRequest withPaymentReference(
...
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p>
            ...
            public SubscriptionRequest withRetryIfPossible(
...
* 
            ...
            public SubscriptionRequest withStartDate(
...
* successful.
 ...
 customerBillingDetail;
                  ...
                  public 
    BillingRequestCollectCustomerDetailsRequest
...
* "it", "nl", "da", "nb", "sl", "sv" are supported. If this is not provided and a customer was
* linked during billing request creation, the linked customer language will be used. Otherwise, the
...
();
 ...
 customerBillingDetail) {
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailAddressLine1(
...
();
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailAddressLine2(
...
();
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailAddressLine3(
...
* code.](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements)
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailCountryCode(
...
* if the customer's bank account is denominated in Danish krone (DKK).
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailDanishIdentityNumber(
...
* their browser).
* 
* Not required for creating offline mandates where `authorisation_source` is set to telephone or
* paper.
* 
                                   */
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailIpAddress(
...
* California).
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailRegion(
...
* denominated in Swedish krona (SEK). This field cannot be changed once it has been set.
    ...
    BillingRequestCollectCustomerDetailsRequest
                                  ...
                                  withCustomerBillingDetailSwedishIdentityNumber(
...
* be a "Personal PAD").
            ...
            public Customer withCompanyName(
...
* to this customer.
 ...
 email) {
            ...
            public Customer withFamilyName(
...
* values up to 500 characters.
 ...
 metadata) {
            ...
            public Customer withPhoneNumber(
 ...
 swedishIdentityNumber;
            ...
            public CustomerBillingDetail withAddressLine1(
 ...
 addressLine1) {
            ...
            public CustomerBillingDetail withAddressLine2(
 ...
 addressLine2) {
            ...
            public CustomerBillingDetail withAddressLine3(
 ...
 addressLine3) {
            ...
            public CustomerBillingDetail withCity(
...
* code.](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements)
            ...
            public CustomerBillingDetail withCountryCode(
...
* if the customer's bank account is denominated in Danish krone (DKK).
            ...
            public CustomerBillingDetail withDanishIdentityNumber(
...
* 
            ...
            public CustomerBillingDetail withIpAddress(
 ...
 ipAddress) {
            ...
            public CustomerBillingDetail withPostalCode(
...
* California).
            ...
            public CustomerBillingDetail withRegion(
...
* denominated in Swedish krona (SEK). This field cannot be changed once it has been set.
            ...
            public CustomerBillingDetail withSwedishIdentityNumber(
...
* number match the details held by the relevant bank.
 ...
 payId;
                      ...
                      /**
                       * Name of the account holder, as known by the bank. This field will be transliterated, upcased and
...
* values up to 500 characters.
    ...
    BillingRequestCollectBankAccountRequest
                      ...
                      /**
                       * A unique record such as an email address, mobile number or company number, that can be used to
* make and accept payments.
 ...
 payId) {
          ...
          private BillingRequestCollectBankAccountRequest(HttpClient httpClient
...
* values up to 500 characters.
                  ...
                  public 
    BillingRequestConfirmPayerDetailsRequest
...
* values up to 500 characters.
    ...
    BillingRequestConfirmPayerDetailsRequest
                      ...
                      /**
                       * This attribute can be set to true if the payer has indicated that multiple signatures are required
* for the mandate. As long as every other Billing Request actions have been completed, the payer
* will receive an email notification containing instructions on how to complete the additional
* signature. The dual signature flow can only be completed using GoCardless branded pages.
                       */
                  
                  public 
    BillingRequestConfirmPayerDetailsRequest

                      withPayerRequestedDualSignature(
 ...
 payerRequestedDualSignature) {
          ...
          private BillingRequestConfirmPayerDetailsRequest(HttpClient httpClient
...
* values up to 500 characters.
    ...
    BillingRequestFulfilRequest
          ...
          private BillingRequestFulfilRequest(HttpClient httpClient
...
* values up to 500 characters.
    ...
    BillingRequestCancelRequest
          ...
          private BillingRequestCancelRequest(HttpClient httpClient
 ...
 withHeader(String headerName, String headerValue) {
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your billing requests.
         */
        public static final class BillingRequestListRequest
        
            <S>
        
        extends
        
            ListRequest<S, BillingRequest>
         {
...
* requests for the given customer.
                       */
 ...
 withHeader(String headerName, String headerValue) {
        ...
        extends
            ...
            GetRequest<BillingRequest>
         {
          ...
          private BillingRequestGetRequest(HttpClient httpClient
...
* This endpoint is currently supported only for Instant Bank Pay Billing Requests.
 ...
 redirectUri) {
          ...
          private BillingRequestNotifyRequest(HttpClient httpClient
...
* have fallback enabled.
        ...
        extends
            ...
            PostRequest<BillingRequest>
         {
          ...
          private BillingRequestFallbackRequest(HttpClient httpClient
...
* "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
                  ...
                  public 
    BillingRequestChooseCurrencyRequest
...
* values up to 500 characters.
    ...
    BillingRequestChooseCurrencyRequest
          ...
          private BillingRequestChooseCurrencyRequest(HttpClient httpClient
...
* alpha-2 code. The country code of the institution. If nothing is provided, institutions with the
* country code 'GB' are returned by default.
                       */
                  
                  public 
    BillingRequestSelectInstitutionRequest
 ...
 institution) {
          ...
          private BillingRequestSelectInstitutionRequest(HttpClient httpClient
