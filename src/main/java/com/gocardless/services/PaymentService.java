...
* `pending_customer_approval`, `pending_submission`, `submitted`, and `active`.
        ...
        list() {
            ...
            (httpClient
                ...
                , ListRequest.<Payment>pagingExecutor()
...
* Payments can be retried up to 3 times.
        ...
        retry(String identity) {
            return new PaymentRetryRequest
...
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p>
 ...
 mandate) {
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your payments.
         */
        public static final class PaymentListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Payment>
         {
...
* </ul>
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum SortField {
            ...
            @SerializedName("charge_date") CHARGE_DATE
    ...
    public enum Status {
            ...
            @SerializedName("pending_customer_approval") PENDING_CUSTOMER_APPROVAL
        
            ,@SerializedName("pending_submission") PENDING_SUBMISSION
        
            ,@SerializedName("submitted") SUBMITTED
        
            ,@SerializedName("confirmed") CONFIRMED
        
            ,@SerializedName("paid_out") PAID_OUT
        
            ,@SerializedName("cancelled") CANCELLED
        
            ,@SerializedName("customer_approval_denied") CUSTOMER_APPROVAL_DENIED
        
            ,@SerializedName("failed") FAILED
        
            ,@SerializedName("charged_back") CHARGED_BACK
...
* to be enabled in [GoCardless dashboard](https://manage.gocardless.com/success-plus). </p>
 ...
 retryIfPossible) {
          ...
          private PaymentUpdateRequest(HttpClient httpClient
...
* values up to 500 characters.
    ...
    PaymentCancelRequest
          ...
          private PaymentCancelRequest(HttpClient httpClient
...
* values up to 500 characters.
    ...
    PaymentRetryRequest
          ...
          private PaymentRetryRequest(HttpClient httpClient
