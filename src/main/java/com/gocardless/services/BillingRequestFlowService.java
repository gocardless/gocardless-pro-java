...
public class BillingRequestFlowService {
    ...
    public BillingRequestFlowService(HttpClient httpClient) {
         ...
         */
        public BillingRequestFlowCreateRequest
        
        create() {
            return new BillingRequestFlowCreateRequest
...
* integrations that manipulate the flow.
         */
        public BillingRequestFlowInitialiseRequest
        
        initialise(String identity) {
            return new BillingRequestFlowInitialiseRequest
...
* integrations that manipulate the flow.
        ...
        extends
            ...
            PostRequest<BillingRequestFlow>
         {
          ...
          private BillingRequestFlowInitialiseRequest(HttpClient httpClient
              ...
              public 
    BillingRequestFlowInitialiseRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
