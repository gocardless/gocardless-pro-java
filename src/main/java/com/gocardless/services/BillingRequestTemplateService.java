...
* a no-code solution for generating various types of multi-user payment links.
* 
...
* 
* Billing Request Templates overcome the key limitation of the Billing Request:
* a Billing Request cannot be shared among multiple users because it is intended
* for single-use and is designed to cater to the unique needs of individual customers.
 */
public class BillingRequestTemplateService {
    ...
    public BillingRequestTemplateService(HttpClient httpClient) {
         ...
         */
        public BillingRequestTemplateListRequest
        
            <ListResponse<BillingRequestTemplate>>
        
        list() {
            return new BillingRequestTemplateListRequest
            ...
            public BillingRequestTemplateListRequest<Iterable<BillingRequestTemplate>> all() {
                return new BillingRequestTemplateListRequest<>(httpClient, ListRequest.<BillingRequestTemplate>iteratingExecutor()
         ...
         */
        public BillingRequestTemplateGetRequest
        
        get(String identity) {
            return new BillingRequestTemplateGetRequest
        ...
        /**
          * 
         */
        public BillingRequestTemplateCreateRequest
        
        create() {
            return new BillingRequestTemplateCreateRequest
        ...
        /**
          * Updates a Billing Request Template, which will affect all future Billing Requests created by this
* template.
         */
        public BillingRequestTemplateUpdateRequest
        
        update(String identity) {
            return new BillingRequestTemplateUpdateRequest
        ...
        extends
            ...
            ListRequest<S, BillingRequestTemplate>
         {
 ...
 paymentRequestScheme;
                  ...
                  public 
    BillingRequestTemplateListRequest<S>
...
* customer.
 ...
 withHeader(String headerName, String headerValue) {
        ...
        extends
            ...
            GetRequest<BillingRequestTemplate>
         {
          ...
          private BillingRequestTemplateGetRequest(HttpClient httpClient
              ...
              public 
    BillingRequestTemplateGetRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
        ...
        extends
            ...
            IdempotentPostRequest<BillingRequestTemplate>
         {
 ...
 redirectUri;
                  ...
                  public 
    BillingRequestTemplateCreateRequest
...
* 
    ...
    BillingRequestTemplateCreateRequest
                                  ...
                                  withMandateRequestConstraintsEndDate(
...
();
    ...
    BillingRequestTemplateCreateRequest
                                  ...
                                  withMandateRequestConstraintsMaxAmountPerPayment(
...
* 
    ...
    BillingRequestTemplateCreateRequest
                                  ...
                                  withMandateRequestConstraintsPaymentMethod(
...
();
    ...
    BillingRequestTemplateCreateRequest
                                  ...
                                  withMandateRequestConstraintsPeriodicLimits(
...
* 
    ...
    BillingRequestTemplateCreateRequest
                                  ...
                                  withMandateRequestConstraintsStartDate(
...
* 
 ...
 mandateRequestDescription) {
                      ...
                      /**
                       * Key-value store of custom data that will be applied to the mandate created when this request is
* fulfilled. Up to 3 keys are permitted, with key names up to 50 characters and values up to 500
* characters.
                       */
...
* characters.
    ...
    BillingRequestTemplateCreateRequest
                              ...
                              withMandateRequestMetadata(String key, String value) {
...
* 
 ...
 paymentRequestDescription) {
                      ...
                      /**
                       * Key-value store of custom data that will be applied to the payment created when this request is
* fulfilled. Up to 3 keys are permitted, with key names up to 50 characters and values up to 500
* characters.
                       */
...
* characters.
    ...
    BillingRequestTemplateCreateRequest
                              ...
                              withPaymentRequestMetadata(String key, String value) {
...
* 
            ...
            public MandateRequestConstraints withEndDate(
 ...
 endDate) {
            ...
            public MandateRequestConstraints withMaxAmountPerPayment(
...
* 
            ...
            public MandateRequestConstraints withPaymentMethod(
...
* 
            ...
            public MandateRequestConstraints withStartDate(
...
* template.
        ...
        extends
            ...
            PutRequest<BillingRequestTemplate>
         {
...
* VRP.
                  ...
                  public 
    BillingRequestTemplateUpdateRequest
...
* customer.
 ...
 redirectUri) {
          ...
          private BillingRequestTemplateUpdateRequest(HttpClient httpClient
