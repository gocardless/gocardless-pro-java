...
* items that make up that payout's amount.  Payout items can only be retrieved for payouts
* created in the last 6 months. Requests for older payouts will return an HTTP status
* <code>410 Gone</code>.
* 
 */
...
* 
* <strong>This endpoint only serves requests for payouts created in the last 6 months. Requests for
* older payouts will return an HTTP status <code>410 Gone</code>.</strong>
* 
         */
        public PayoutItemListRequest
        
            <ListResponse<PayoutItem>>
        
        list() {
            return new PayoutItemListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<PayoutItem>pagingExecutor()
...
* 
         */
        public static final class PayoutItemListRequest
        
            <S>
        
        extends
        
            ListRequest<S, PayoutItem>
         {
