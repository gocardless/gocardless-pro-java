...
public class CreditorService {
    ...
    public CreditorService(HttpClient httpClient) {
         ...
         */
        public CreditorCreateRequest
        
        create() {
            return new CreditorCreateRequest
         ...
         */
        public CreditorListRequest
        
            <ListResponse<Creditor>>
        
        list() {
            return new CreditorListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<Creditor>pagingExecutor()
         ...
         */
        public CreditorGetRequest
        
        get(String identity) {
            return new CreditorGetRequest
         ...
         */
        public CreditorUpdateRequest
        
        update(String identity) {
            return new CreditorUpdateRequest
        ...
        extends
            ...
            IdempotentPostRequest<Creditor>
         {
...
* `partnership`, and `trust` are supported.
 ...
 links) {
    ...
    CreditorCreateRequest
                              ...
                              withLinks(String key, String value) {
                              if (links == null) {
                                  links = new HashMap<>();
                              }
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum CreditorType {
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your creditors.
         */
        public static final class CreditorListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Creditor>
         {
...
* payouts in AUD.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultAudPayoutAccount(
...
* payouts in CAD.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultCadPayoutAccount(
                                      
    
        String
    
 defaultCadPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
* payouts in DKK.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultDkkPayoutAccount(
                                      
    
        String
    
 defaultDkkPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
* payouts in EUR.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultEurPayoutAccount(
                                      
    
        String
    
 defaultEurPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
* payouts in GBP.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultGbpPayoutAccount(
                                      
    
        String
    
 defaultGbpPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
* payouts in NZD.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultNzdPayoutAccount(
                                      
    
        String
    
 defaultNzdPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
* payouts in SEK.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultSekPayoutAccount(
                                      
    
        String
    
 defaultSekPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
* payouts in USD.
    ...
    CreditorUpdateRequest
                                  ...
                                  withLinksDefaultUsdPayoutAccount(
                                      
    
        String
    
 defaultUsdPayoutAccount
                                  ) {
                                  if (links == null) {
                                      links = new 
...
();
 ...
 region) {
          ...
          private CreditorUpdateRequest(HttpClient httpClient
...
* payouts in AUD.
            ...
            public Links withDefaultAudPayoutAccount(
...
* payouts in CAD.
            ...
            public Links withDefaultCadPayoutAccount(
...
* payouts in DKK.
            ...
            public Links withDefaultDkkPayoutAccount(
...
* payouts in EUR.
            ...
            public Links withDefaultEurPayoutAccount(
...
* payouts in GBP.
            ...
            public Links withDefaultGbpPayoutAccount(
...
* payouts in NZD.
            ...
            public Links withDefaultNzdPayoutAccount(
...
* payouts in SEK.
            ...
            public Links withDefaultSekPayoutAccount(
...
* payouts in USD.
            ...
            public Links withDefaultUsdPayoutAccount(
