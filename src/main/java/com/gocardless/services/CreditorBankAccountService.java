...
public class CreditorBankAccountService {
    ...
    public CreditorBankAccountService(HttpClient httpClient) {
         ...
         */
        public CreditorBankAccountCreateRequest
        
        create() {
            return new CreditorBankAccountCreateRequest
        ...
        public CreditorBankAccountListRequest
            ...
            <ListResponse<CreditorBankAccount>>
        
        list() {
            return new CreditorBankAccountListRequest
            ...
            public CreditorBankAccountListRequest<Iterable<CreditorBankAccount>> all() {
                return new CreditorBankAccountListRequest<>(httpClient, ListRequest.<CreditorBankAccount>iteratingExecutor()
         ...
         */
        public CreditorBankAccountGetRequest
        
        get(String identity) {
            return new CreditorBankAccountGetRequest
...
* details.
         */
        public CreditorBankAccountDisableRequest
        
        disable(String identity) {
            return new CreditorBankAccountDisableRequest
...
* truncated to 18 characters.
                  ...
                  public 
    CreditorBankAccountCreateRequest
...
* values up to 500 characters.
    ...
    CreditorBankAccountCreateRequest
                      ...
                      /**
                       * Defaults to `true`. When this is set to `true`, it will cause this bank account to be set as the
* account that GoCardless will pay out to.
 ...
 enabled;
                  ...
                  public 
    CreditorBankAccountListRequest<S>
...
();
 ...
 lte) {
        ...
        extends
            ...
            GetRequest<CreditorBankAccount>
         {
...
* details.
        ...
        extends
            ...
            PostRequest<CreditorBankAccount>
         {
          ...
          private CreditorBankAccountDisableRequest(HttpClient httpClient
              ...
              public 
    CreditorBankAccountDisableRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
