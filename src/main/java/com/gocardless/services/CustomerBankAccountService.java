...
* error response.
* 
* _Note:_ To ensure the customer's bank accounts are valid, verify them first
* using
...
* details](#appendix-local-bank-details).
         */
        public CustomerBankAccountCreateRequest
        
        create() {
            return new CustomerBankAccountCreateRequest
         ...
         */
        public CustomerBankAccountListRequest
        
            <ListResponse<CustomerBankAccount>>
        
        list() {
            return new CustomerBankAccountListRequest
            ...
            public CustomerBankAccountListRequest<Iterable<CustomerBankAccount>> all() {
                return new CustomerBankAccountListRequest<>(httpClient, ListRequest.<CustomerBankAccount>iteratingExecutor()
         ...
         */
        public CustomerBankAccountGetRequest
        
        get(String identity) {
            return new CustomerBankAccountGetRequest
         ...
         */
        public CustomerBankAccountUpdateRequest
        
        update(String identity) {
            return new CustomerBankAccountUpdateRequest
...
* details.
         */
        public CustomerBankAccountDisableRequest
        
        disable(String identity) {
            return new CustomerBankAccountDisableRequest
...
* place of bank account parameters.
    ...
    CustomerBankAccountCreateRequest
                                  ...
                                  withLinksCustomerBankAccountToken(
...
* place of bank account parameters.
            ...
            public Links withCustomerBankAccountToken(
 ...
 enabled;
                  ...
                  public 
    CustomerBankAccountListRequest<S>
...
();
 ...
 lte) {
        ...
        extends
            ...
            GetRequest<CustomerBankAccount>
         {
...
* values up to 500 characters.
    ...
    CustomerBankAccountUpdateRequest
          ...
          private CustomerBankAccountUpdateRequest(HttpClient httpClient
...
* details.
        ...
        extends
            ...
            PostRequest<CustomerBankAccount>
         {
          ...
          private CustomerBankAccountDisableRequest(HttpClient httpClient
              ...
              public 
    CustomerBankAccountDisableRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
