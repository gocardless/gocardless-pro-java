...
public class BalanceService {
     ...
     * of this class can be obtained by calling
      {@link com.gocardless.GoCardlessClient#balances() }.
     */
    public BalanceService(HttpClient httpClient) {
        ...
        /**
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of balances for a given creditor.
* This endpoint is rate limited to 60 requests per minute.
        ...
        list() {
            return new BalanceListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<Balance>pagingExecutor()
...
* This endpoint is rate limited to 60 requests per minute.
         */
        public static final class BalanceListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Balance>
         {
