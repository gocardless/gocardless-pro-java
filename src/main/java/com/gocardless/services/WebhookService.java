...
public class WebhookService {
     ...
     */
    public WebhookGetRequest get(String identity) {
        return new WebhookGetRequest(httpClient, identity);
    }

    /**
     * Requests for a previous webhook to be sent again
     */
    public WebhookRetryRequest retry(String identity) {
        return new WebhookRetryRequest(httpClient, identity);
    }
    ...
    public static final class WebhookListRequest<S> extends ListRequest<S, Webhook> {
         ...
         */
        public WebhookListRequest<S> withAfter(String after) {
            setAfter(after);
            return this;
        }
         ...
         */
        public WebhookListRequest<S> withBefore(String before) {
            setBefore(before);
            return this;
        }

        public WebhookListRequest<S> withCreatedAt(CreatedAt createdAt) {
         ...
         */
        public WebhookListRequest<S> withCreatedAtGt(String gt) {
            if (createdAt == null) {
         ...
         */
        public WebhookListRequest<S> withCreatedAtGte(String gte) {
            if (createdAt == null) {
                createdAt = new CreatedAt();
            }
         ...
         */
        public WebhookListRequest<S> withCreatedAtLt(String lt) {
            if (createdAt == null) {
                createdAt = new CreatedAt();
            }
            createdAt.withLt(lt);
         ...
         */
        public WebhookListRequest<S> withCreatedAtLte(String lte) {
            if (createdAt == null) {
                createdAt = new CreatedAt();
            }
         ...
         */
        public WebhookListRequest<S> withIsTest(Boolean isTest) {
            this.isTest = isTest;
            return this;
        }
         ...
         */
        public WebhookListRequest<S> withLimit(Integer limit) {
            setLimit(limit);
            return this;
        }
         ...
         */
        public WebhookListRequest<S> withSuccessful(Boolean successful) {
            this.successful = successful;
            return this;
        }

        private WebhookListRequest(HttpClient httpClient, ListRequestExecutor<S, Webhook> executor) {
            super(httpClient, executor);
        }

        public WebhookListRequest<S> withHeader(String headerName, String headerValue) {
     ...
     * Retrieves the details of an existing webhook.
     */
    public static final class WebhookGetRequest extends GetRequest<Webhook> {
        @PathParam
        private final String identity;

        private WebhookGetRequest(HttpClient httpClient, String identity) {
            super(httpClient);
            this.identity = identity;
        }

        public WebhookGetRequest withHeader(String headerName, String headerValue) {
            this.addHeader(headerName, headerValue);
            return this;
        }
     ...
     * Requests for a previous webhook to be sent again
     */
    public static final class WebhookRetryRequest extends PostRequest<Webhook> {
        @PathParam
        private final String identity;

        private WebhookRetryRequest(HttpClient httpClient, String identity) {
            super(httpClient);
            this.identity = identity;
        }

        public WebhookRetryRequest withHeader(String headerName, String headerValue) {
            this.addHeader(headerName, headerValue);
            return this;
        }
