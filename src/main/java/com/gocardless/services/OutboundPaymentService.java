...
* 
* <p class="restricted-notice"><strong>Restricted</strong>: Outbound Payments are currently in Early
* Access and available only to a limited list of organisations. If you are interested in using this
* feature, please stay tuned for our public launch announcement. We are actively testing and
* refining our API to ensure it meets your needs and provides the best experience.</p>
 */
public class OutboundPaymentService {
     ...
     * of this class can be obtained by calling
      {@link com.gocardless.GoCardlessClient#outboundPayments() }.
     */
    public OutboundPaymentService(HttpClient httpClient) {
        ...
        /**
          * 
         */
        public OutboundPaymentCreateRequest
        
        create() {
            return new OutboundPaymentCreateRequest
         ...
         */
        public OutboundPaymentWithdrawRequest
        
        withdraw() {
            return new OutboundPaymentWithdrawRequest
        ...
        /**
          * Cancels an outbound payment. Only outbound payments with either `verifying`, `pending_approval`,
* or `scheduled` status can be cancelled.
* Once an outbound payment is `executing`, the money moving process has begun and cannot be
* reversed.
         */
        public OutboundPaymentCancelRequest
        
        cancel(String identity) {
            return new OutboundPaymentCancelRequest
        ...
        /**
          * Approves an outbound payment. Only outbound payments with the “pending_approval” status can be
* approved.
         */
        public OutboundPaymentApproveRequest
        
        approve(String identity) {
            return new OutboundPaymentApproveRequest
         ...
         */
        public OutboundPaymentGetRequest
        
        get(String identity) {
            return new OutboundPaymentGetRequest
         ...
         */
        public OutboundPaymentListRequest
        
            <ListResponse<OutboundPayment>>
        
        list() {
            return new OutboundPaymentListRequest
            ...
            public OutboundPaymentListRequest<Iterable<OutboundPayment>> all() {
                return new OutboundPaymentListRequest<>(httpClient, ListRequest.<OutboundPayment>iteratingExecutor()
         ...
         */
        public OutboundPaymentUpdateRequest
        
        update(String identity) {
            return new OutboundPaymentUpdateRequest
        ...
        extends
            ...
            IdempotentPostRequest<OutboundPayment>
         {
...
* "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 &-./"<br />
 ...
 reference) {
                      ...
                      /**
                       * Bank payment scheme to process the outbound payment. Currently only "faster_payments" (GBP) is
* supported.
                       */
 ...
 creditor) {
            ...
            public Links withRecipientBankAccount(
 ...
 recipientBankAccount) {
         ...
         *
          * Creates an outbound payment to your verified business bank account as the recipient.
         */
        public static final class OutboundPaymentWithdrawRequest
        
        extends
        
            PostRequest<OutboundPayment>
         {
...
* reversed.
         */
        public static final class OutboundPaymentCancelRequest
...
* key names up to 50 characters and values up to 500 characters.
    ...
    OutboundPaymentCancelRequest
          ...
          private OutboundPaymentCancelRequest(HttpClient httpClient
...
* approved.
         */
        public static final class OutboundPaymentApproveRequest
        ...
        extends
            ...
            PostRequest<OutboundPayment>
         {
          ...
          private OutboundPaymentApproveRequest(HttpClient httpClient
 ...
 withHeader(String headerName, String headerValue) {
         ...
         *
          * Fetches an outbound_payment by ID
         */
        public static final class OutboundPaymentGetRequest
        
        extends
        
            GetRequest<OutboundPayment>
         {
          ...
          private OutboundPaymentGetRequest(HttpClient httpClient
 ...
 limit) {
                       ...
                       * One of:
* <ul>
* <li>`verifying`: The payment has been [created](#outbound-payments-create-an-outbound-payment) and
* the verification process has begun.</li>
...
* [approval](#outbound-payments-approve-an-outbound-payment), but processing has not yet begun.</li>
...
* recipient.</li>
* <li>`cancelled`: The payment has been [cancelled](#outbound-payments-cancel-an-outbound-payment)
* or was not [approved](#outbound-payments-approve-an-outbound-payment) on time.</li>
* <li>`failed`: The payment was not sent, usually due to an error while or after executing.</li>
* </ul>
                       */
 ...
 withHeader(String headerName, String headerValue) {
    ...
    public enum Status {
            ...
            ,@SerializedName("executing") EXECUTING
        
            ,@SerializedName("executed") EXECUTED
         ...
         *
          * Updates an outbound payment object. This accepts only the metadata parameter.
         */
        public static final class OutboundPaymentUpdateRequest
        
        extends
        
            PutRequest<OutboundPayment>
         {
...
* key names up to 50 characters and values up to 500 characters.
    ...
    OutboundPaymentUpdateRequest
          ...
          private OutboundPaymentUpdateRequest(HttpClient httpClient
