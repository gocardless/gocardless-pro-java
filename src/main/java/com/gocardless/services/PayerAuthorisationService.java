...
*   <a href="https://developer.gocardless.com/getting-started/billing-requests/overview/">
*   Billing Requests</a>. Use Billing Requests to build any future integrations.
* </p>
* 
...
* status of a Payer Authorisation.
         */
        public PayerAuthorisationGetRequest
        
        get(String identity) {
            return new PayerAuthorisationGetRequest
...
* such as a multi-step form.
        ...
        create() {
            return new PayerAuthorisationCreateRequest
...
* previously existing values. </p>
        ...
        update(String identity) {
            return new PayerAuthorisationUpdateRequest
...
* edited.
         */
        public PayerAuthorisationSubmitRequest
        
        submit(String identity) {
            return new PayerAuthorisationSubmitRequest
...
* </p>
         */
        public PayerAuthorisationConfirmRequest
        
        confirm(String identity) {
            return new PayerAuthorisationConfirmRequest
...
* status of a Payer Authorisation.
        ...
        extends
            ...
            GetRequest<PayerAuthorisation>
         {
          ...
          private PayerAuthorisationGetRequest(HttpClient httpClient
...
* [Customer Bank Account](#core-endpoints-customer-bank-accounts).
                  ...
                  public 
    PayerAuthorisationCreateRequest
...
* account token](#javascript-flow-customer-bank-account-tokens).
    ...
    PayerAuthorisationCreateRequest
                                  ...
                                  withBankAccountAccountHolderName(
...
* details](#local-bank-details-new-zealand) for more information.
    ...
    PayerAuthorisationCreateRequest
                                  ...
                                  withBankAccountAccountNumberSuffix(
...
* if the customer's bank account is denominated in Danish krone (DKK).
    ...
    PayerAuthorisationCreateRequest
                                  ...
                                  withCustomerDanishIdentityNumber(
...
* denominated in Swedish krona (SEK). This field cannot be changed once it has been set.
    ...
    PayerAuthorisationCreateRequest
                                  ...
                                  withCustomerSwedishIdentityNumber(
...
* account token](#javascript-flow-customer-bank-account-tokens).
            ...
            public BankAccount withAccountHolderName(
...
* Alternatively you can provide an `iban`.
            ...
            public BankAccount withAccountNumber(
...
* for other currencies.
            ...
            public BankAccount withAccountNumberEnding(
...
* details](#local-bank-details-new-zealand) for more information.
            ...
            public BankAccount withAccountNumberSuffix(
...
* information.
            ...
            public BankAccount withAccountType(
...
* you can provide an `iban`.
            ...
            public BankAccount withBankCode(
...
* Alternatively you can provide an `iban`.
            ...
            public BankAccount withBranchCode(
...
* to the country code of the `iban` if supplied, otherwise is required.
            ...
            public BankAccount withCountryCode(
...
* "CAD", "DKK", "EUR", "GBP", "NZD", "SEK" and "USD" are supported.
            ...
            public BankAccount withCurrency(
...
* values up to 500 characters.
            ...
            public BankAccount withMetadata(
 ...
 swedishIdentityNumber;
            ...
            public Customer withAddressLine1(
 ...
 addressLine1) {
            ...
            public Customer withAddressLine2(
 ...
 addressLine2) {
            ...
            public Customer withAddressLine3(
...
* code.](http://en.wikipedia.org/wiki/ISO_3166-1_alpha-2#Officially_assigned_code_elements)
            ...
            public Customer withCountryCode(
...
* if the customer's bank account is denominated in Danish krone (DKK).
            ...
            public Customer withDanishIdentityNumber(
...
* values up to 500 characters.
 ...
 metadata) {
            ...
            public Customer withPostalCode(
...
* denominated in Swedish krona (SEK). This field cannot be changed once it has been set.
            ...
            public Customer withSwedishIdentityNumber(
...
* 
            ...
            public Mandate withPayerIpAddress(
...
* [Customer Bank Account](#core-endpoints-customer-bank-accounts).
                  ...
                  public 
    PayerAuthorisationUpdateRequest
...
();
          ...
          private PayerAuthorisationUpdateRequest(HttpClient httpClient
...
* edited.
        ...
        extends
            ...
            PostRequest<PayerAuthorisation>
         {
          ...
          private PayerAuthorisationSubmitRequest(HttpClient httpClient
              ...
              public 
    PayerAuthorisationSubmitRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
...
* </p>
        ...
        extends
            ...
            PostRequest<PayerAuthorisation>
         {
          ...
          private PayerAuthorisationConfirmRequest(HttpClient httpClient
              ...
              public 
    PayerAuthorisationConfirmRequest
 withHeader(String headerName, String headerValue) {
                  this.addHeader(headerName, headerValue);
                  return this;
              }
