...
public class BankAccountDetailService {
    ...
    public BankAccountDetailService(HttpClient httpClient) {
        ...
        get(String identity) {
            return new BankAccountDetailGetRequest
         ...
         *
          * Returns bank account details in the flattened JSON Web Encryption format described in RFC 7516
         */
        public static final class BankAccountDetailGetRequest
        
        extends
        
            GetRequest<BankAccountDetail>
         {
          ...
          private BankAccountDetailGetRequest(HttpClient httpClient
