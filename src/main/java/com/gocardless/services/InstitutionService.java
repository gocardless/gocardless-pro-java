...
public class InstitutionService {
    ...
    public InstitutionService(HttpClient httpClient) {
        ...
        list() {
            return new InstitutionListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<Institution>pagingExecutor()
            ...
            public InstitutionListRequest<Iterable<Institution>> all() {
                return new InstitutionListRequest<>(httpClient, ListRequest.<Institution>iteratingExecutor()
...
* This endpoint is currently supported only for FasterPayments.
         */
        public InstitutionListForBillingRequestRequest
        
            <Iterable<Institution>>
        
        listForBillingRequest(String identity) {
            return new InstitutionListForBillingRequestRequest
         ...
         *
          * Returns a list of supported institutions.
         */
        public static final class InstitutionListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Institution>
         {
 ...
 scheme;
                      ...
                      /**
                       * (Currently only supports UK sort-codes) The six-digit number that identifies both the bank and the
* specific branch where an account is held, eg. '601234'.
                       */
                  
                  public 
    InstitutionListRequest<S>
...
* country code 'GB' are returned by default.
 ...
 countryCode) {
                      ...
                      /**
                       * The feature that institutions support. The available options include `pis`, and `vrp_sweeping`. If
* nothing is provided, institutions supporting 'pis' are returned by default.
                       */
...
* `sepa_credit_transfer`, and `sepa_instant_credit_transfer`. If nothing is provided, institutions
...
* country code 'GB' are returned by default.
                  ...
                  public 
    InstitutionListForBillingRequestRequest<S>
 ...
 countryCode) {
                      ...
                      /**
                       * ID(s) of the institution(s) to retrieve. More than one ID can be specified using a comma-separated
* string.
                       */
...
* string.
 ...
 ids) {
                      ...
                      /**
                       * Indicates whether to include temporarily disabled institutions in the response.
