...
public class ScenarioSimulatorService {
    ...
    public ScenarioSimulatorService(HttpClient httpClient) {
         ...
         */
        public ScenarioSimulatorRunRequest
        
        run(String identity) {
            return new ScenarioSimulatorRunRequest
         ...
         *
          * Runs the specific scenario simulator against the specific resource
         */
        public static final class ScenarioSimulatorRunRequest
        
        extends
        
            PostRequest<ScenarioSimulator>
         {
...
();
          ...
          private ScenarioSimulatorRunRequest(HttpClient httpClient
