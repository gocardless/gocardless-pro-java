...
* 
         */
        public CustomerNotificationHandleRequest
        
        handle(String identity) {
            return new CustomerNotificationHandleRequest
...
* 
        ...
        extends
            ...
            PostRequest<CustomerNotification>
         {
          ...
          private CustomerNotificationHandleRequest(HttpClient httpClient
              ...
              public 
    CustomerNotificationHandleRequest
