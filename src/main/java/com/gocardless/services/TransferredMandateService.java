...
public class TransferredMandateService {
    ...
    public TransferredMandateService(HttpClient httpClient) {
         ...
         */
        public TransferredMandateTransferredMandatesRequest
        
        transferredMandates(String identity) {
            return new TransferredMandateTransferredMandatesRequest
        ...
        extends
            ...
            GetRequest<TransferredMandate>
         {
          ...
          private TransferredMandateTransferredMandatesRequest(HttpClient httpClient
              ...
              public 
    TransferredMandateTransferredMandatesRequest
