...
public class CurrencyExchangeRateService {
    ...
    public CurrencyExchangeRateService(HttpClient httpClient) {
        ...
        public CurrencyExchangeRateListRequest
            ...
            <ListResponse<CurrencyExchangeRate>>
        
        list() {
            return new CurrencyExchangeRateListRequest
            ...
            public CurrencyExchangeRateListRequest<Iterable<CurrencyExchangeRate>> all() {
                return new CurrencyExchangeRateListRequest<>(httpClient, ListRequest.<CurrencyExchangeRate>iteratingExecutor()
 ...
 target;
                  ...
                  public 
    CurrencyExchangeRateListRequest<S>
