...
* Italian (`it`), Portuguese (`pt`), Spanish (`es`), Swedish (`sv`) |
         */
        public MandatePdfCreateRequest
        
        create() {
            return new MandatePdfCreateRequest
...
* Alternatively you can provide an `iban`.
 ...
 city) {
                      ...
                      /**
                       * The customer's company name. Used to populate the "Customer Name or Company name" field on the
* PDF.
                       */
...
* supplied for Betalingsservice mandates.
 ...
 danishIdentityNumber) {
                      ...
                      /**
                       * The customer's family name (i.e. last name). Used to populate the "Customer Name or Company name"
* field on the PDF. Ignored if `company_name` is provided.
                       */
 ...
 familyName) {
                      ...
                      /**
                       * The customer's given name (i.e. first name). Used to populate the "Customer Name or Company name"
* field on the PDF. Ignored if `company_name` is provided.
                       */
...
* details](#appendix-local-bank-details). IBANs cannot be provided for Autogiro mandates.
 ...
 links) {
                      ...
                      return this;
                                  ...
                                  /**
                                    * ID of an existing [creditor](#core-endpoints-creditors). Only required if your account manages
* multiple creditors.
                                   */
