...
* 
        ...
        list() {
            return new RefundListRequest
            
                <>
            
            (httpClient
            
                , ListRequest.<Refund>pagingExecutor()
        ...
        update(String identity) {
            return new RefundUpdateRequest
...
* <p class="notice">It is possible to opt out of requiring `total_amount_confirmation`, please
* contact <a href="mailto:support@gocardless.com">our support team</a> for more information.</p>
                       */
                  
                  public 
    RefundCreateRequest

                      withTotalAmountConfirmation(
...
* by contacting <a href="mailto:support@gocardless.com">our support team</a>.</p>
 ...
 payment) {
         ...
         *
          * Returns a [cursor-paginated](#api-usage-cursor-pagination) list of your refunds.
         */
        public static final class RefundListRequest
        
            <S>
        
        extends
        
            ListRequest<S, Refund>
         {
...
* </ul>
 ...
 refundType) {
          ...
          private RefundListRequest(HttpClient httpClient
                  ...
                  , ListRequestExecutor<S, Refund> executor
...
* values up to 500 characters.
    ...
    RefundUpdateRequest
          ...
          private RefundUpdateRequest(HttpClient httpClient
