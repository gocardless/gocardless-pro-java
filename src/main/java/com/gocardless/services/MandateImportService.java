...
* [submit](#mandate-imports-submit-a-mandate-import) it.
         */
        public MandateImportCreateRequest
        
        create() {
            return new MandateImportCreateRequest
         ...
         */
        public MandateImportGetRequest
        
        get(String identity) {
            return new MandateImportGetRequest
...
* processing has begun.
         */
        public MandateImportSubmitRequest
        
        submit(String identity) {
            return new MandateImportSubmitRequest
...
* cannot be cancelled.
         */
        public MandateImportCancelRequest
        
        cancel(String identity) {
            return new MandateImportCancelRequest
    ...
    public enum Scheme {
        ...
        extends
            ...
            GetRequest<MandateImport>
         {
          ...
          private MandateImportGetRequest(HttpClient httpClient
...
* processing has begun.
        ...
        extends
            ...
            PostRequest<MandateImport>
         {
          ...
          private MandateImportSubmitRequest(HttpClient httpClient
...
* cannot be cancelled.
        ...
        extends
            ...
            PostRequest<MandateImport>
         {
          ...
          private MandateImportCancelRequest(HttpClient httpClient
