...
public class MandateImportService {
     ...
     * class can be obtained by calling {@link com.gocardless.GoCardlessClient#mandateImports() }.
     */
    ...
    /**
     * Submits the mandate import, which allows it to be processed by a member of the GoCardless
     * team. Once the import has been submitted, it can no longer have entries added to it.
     * 
     * In our sandbox environment, to aid development, we automatically process mandate imports
     * approximately 10 seconds after they are submitted. This will allow you to test both the
     * "submitted" response and wait for the webhook to confirm the processing has begun.
     */
    ...
    /**
     * Cancels the mandate import, which aborts the import process and stops the mandates being set
     * up in GoCardless. Once the import has been cancelled, it can no longer have entries added to
     * it. Mandate imports which have already been submitted or processed cannot be cancelled.
     */
