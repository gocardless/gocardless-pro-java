...
public class GoCardlessClient {
    ...
    public static final class Builder {
        ...
        private long waitBetweenRetriesInMilliSeconds = HttpClient.WAIT_BETWEEN_RETRIES_IN_MILLI_SECONDS;
         ...
         *
         * @param maxNoOfRetries The maximum number of times that a request can be retried.
         * maximum is 3 times
         */
        public Builder withMaxNoOfRetries(int maxNoOfRetries) {
         ...
         /**
         * Configures the fixed wait strategy time the client should wait before retrying a failed request
         *
         * @param maxNoOfRetries The amount of time to wait before retrying a failed request in milli seconds
         */
        ...
        public GoCardlessClient build() {
            ...
            HttpClient client = new HttpClient(accessToken, baseUrl, rawClient, errorOnIdempotencyConflict, maxNoOfRetries, waitBetweenRetriesInMilliSeconds);
