...
public class ExampleClient {
    private final ExampleHttpClient httpClient;
    ...
    private ExampleClient(ExampleHttpClient httpClient) {
    ...
    @VisibleForTesting
    ExampleHttpClient getHttpClient() {
        return httpClient;
    }

    public static ExampleClient create(String apiKey, String apiSecret, String baseUrl) {
        return new ExampleClient(new ExampleHttpClient(apiKey, apiSecret, baseUrl));
    }
}
