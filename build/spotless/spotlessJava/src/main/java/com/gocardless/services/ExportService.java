...
public class ExportService {
     ...
     */
    public ExportListRequest<ListResponse<Export>> list() {
        return new ExportListRequest<>(httpClient, ListRequest.<Export>pagingExecutor());
    }
     ...
     * Returns a single export.
     */
    public static final class ExportGetRequest extends GetRequest<Export> {
        @PathParam
     ...
     * Returns a list of exports which are available for download.
     */
    public static final class ExportListRequest<S> extends ListRequest<S, Export> {
        /**
         * Cursor pointing to the start of the desired set.
         */
        public ExportListRequest<S> withAfter(String after) {
            setAfter(after);
            return this;
        }
         ...
         */
        public ExportListRequest<S> withBefore(String before) {
            setBefore(before);
            return this;
        }
         ...
         */
        public ExportListRequest<S> withLimit(Integer limit) {
            setLimit(limit);
            return this;
        }

        private ExportListRequest(HttpClient httpClient, ListRequestExecutor<S, Export> executor) {
            super(httpClient, executor);
        }

        public ExportListRequest<S> withHeader(String headerName, String headerValue) {
            this.addHeader(headerName, headerValue);
            return this;
        }
